        ...
        <div class="content">
          <el-form style="text-align:left" :inline="true" ref="myForm" :model="queryFormData" :rules='rules' class="demo-form-inline">
            <el-form-item label="" prop='target_ip'>
              <el-input v-model="queryFormData.target_ip" placeholder="目的主机"></el-input>
            </el-form-item>
            <el-form-item label="" prop='target_port'>
              <el-input v-model="queryFormData.target_port" placeholder="目的端口"></el-input>
            </el-form-item>
            ...
            <el-form-item>
              ...
              <el-button style="padding:7px 12px" icon='el-icon-download' type="primary" @click="exportLog()">导出当前日志</el-button>
            </el-form-item>
          </el-form>  
          <el-table :data='logsData' border v-loading="isQueryLoading">
            <el-table-column type='index' label='序号' width="80" align="center"></el-table-column>
            <el-table-column prop='target_ip' label='目标主机IP' align="center"></el-table-column>
            <el-table-column prop='target_port' label='目标主机端口' align="center"></el-table-column>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        target_port: [{ validator: checkPort, trigger: 'blur' }]
      }
    }
  },
  created () {
  ...
  methods: {
    ...
    getAttackLogs () {
      let send = {
        ...
        target_port: this.queryFormData.target_port,

...
}; a.Fx = function(a, f, p) { this.options = f; this.elem = a; this.prop = p }; a.Fx.prototype = {dSetter: function() { var a = this.paths[0], f = this.paths[1], p = [], v = this.now, l = a.length, u; if(v===1)p = this.toD; else if(l === f.length && v<1)for(;l--;)u = parseFloat(a[l]), p[l] = isNaN(u) ? a[l]:v * parseFloat(f[l] - u) + u; else p = f; this.elem.attr('d', p, null, !0) },
 update: function() {
...
2])}
 }function l(a, e) { for(;a.length < m;) { a[0] = e[m - a.length]; var b = a.slice(0, t); [].splice.apply(a, [0, 0].concat(b)); z && (b = a.slice(a.length - t), [].splice.apply(a, [a.length, 0].concat(b)), q--) }a[0] = 'M' }function u(a, e) { for(var c = (m - a.length) / t; c>0 && c--;)b = a.slice().splice(a.length / F - t, t * F), b[0] = e[m - t - c * t], y && (b[t - 6] = b[t - 2], b[t - 5] = b[t - 1]), [].splice.apply(a, [a.length / F, 0].concat(b)), z && c-- }f = f || ''; var d, c = h.startX, n = h.endX, y = f.indexOf("C")>-1, t = y ? 7:3, m, b, q; f = f.split(' '); p = p.slice(); var z = h.isArea, F = z ? 2:1, e
...
"";} h = a.pick(h, '%Y-%m-%d %H:%M:%S'); var v = a.Date, l = new v(f - a.getTZOffset(f)), u, d = l[v.hcGetHours](), c = l[v.hcGetDay](), n = l[v.hcGetDate](), y = l[v.hcGetMonth](), t = l[v.hcGetFullYear](), m = a.defaultOptions.lang, b = m.weekdays, q = m.shortWeekdays, z = a.pad, v = a.extend({a: q ? q[c]:b[c].substr(0, 3),
A: b[c],
 d: z(n),
 e: z(n, 2, ' '),
 w: c,
...
S: z(l.getSeconds()),
 L: z(Math.round(f %
1E3), 3)}, a.dateFormats); for(u in v)for(;h.indexOf("%"+u)!==-1;)h = h.replace('%' + u, 'function' === typeof v[u] ? v[u](f):v[u]); return p ? h.substr(0, 1).toUpperCase() + h.substr(1):h
 }; a.formatSingle = function(h, f) { var p = /\.([0-9])/, v = a.defaultOptions.lang; /f$/.test(h) ? (p = (p = h.match(p)) ? p[1]:-1, f!==null && (f = a.numberFormat(f, p, v.decimalPoint, h.indexOf(",")>-1 ? v.thousandsSep:''))):f = a.dateFormat(h, f); return f }; a.format = function(h, f) {
 for(var p = '{', v = !1, l, u, d, c, n = [], y; h;) {
p = h.indexOf(p); if(p===-1)break; l = h.slice(0,
p); if(v) { l = l.split(':'); u = l.shift().split('.'); c = u.length; y = f; for(d = 0; d < c; d++)y = y[u[d]]; l.length && (y = a.formatSingle(l.join(':'), y)); n.push(y) }else n.push(l); h = h.slice(p + 1); p = (v = !v) ? '}':'{'
 ...
 var u, d = h; p = a.pick(p, 1); u = h / p; f || (f = l ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10]:[1, 2, 2.5, 5, 10], !1 === v && (p===1 ? f = a.grep(f, function(a) { return a%1===0 }):0p<=.1 && (f = [1 / p])))
for(v = 0; v < f.length && !(d = f[v], l && d * p >= h || !l && u <= (f[v] + (f[v + 1] || f[v])) / 2); v++);return d * p
 }; a.stableSort = function(a, f) { var p = a.length, h, l; for(l = 0; l < p; l++)a[l].safeI = l; a.sort(function(a, d) { h = f(a, d); return h===0 ? a.safeI - d.safeI:h }); for(l = 0; l < p; l++)delete a[l].safeI }; a.arrayMin = function(a) { for(var f = a.length, p = a[0]; f--;)a[f] < p && (p = a[f]); return p }; a.arrayMax = function(a) { for(var f = a.length, p = a[0]; f--;)a[f] > p && (p = a[f]); return p }; a.destroyObjectProperties = function(a, f) {
...
d[c].length;a--;)v(c,d[c][a])}
 }var u, d = h.hcEvents, c; d && (f ? (u = d[f] || [], p ? (c = a.inArray(p, u), c>-1 && (u.splice(c, 1), d[f] = u), v(f, p)):(l(), d[f] = [])):(l(), h.hcEvents = {}))
...
type:f}),f=0;f<u;f++)(d=l[f])&&!1===d.call(h,p)&&p.preventDefault();} v && !p.defaultPrevented && v(p)
...
f && (h = h.replace(/alpha\(opacity=([0-9]+)\)/, function(a, l) { return l / 100 })); return'' === h ? 1:a.pInt(h)
 ...
 var D = a.each, C = a.isNumber, G = a.map, I = a.merge, h = a.pInt; a.Color = function(f) { if(!(this instanceof a.Color))return new a.Color(f); this.init(f) }; a.Color.prototype = {parsers: [{regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function(a) { return[h(a[1]), h(a[2]), h(a[3]), parseFloat(a[4], 10)] }}, {regex: /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
parse: function(a) {
 return[h(a[1],
16), h(a[2], 16), h(a[3], 16), 1]
 ...
 init: function(f) { var p, h, l, u; if((this.input = f = this.names[f] || f) && f.stops)this.stops = G(f.stops, function(d) { return new a.Color(d[1]) }); else for(l = this.parsers.length; l-- && !h;)u = this.parsers[l], (p = u.regex.exec(f)) && (h = u.parse(p)); this.rgba = h || [] },
 get: function(a) {
var f = this.input, h = this.rgba, l; this.stops ?
(l = I(f), l.stops = [].concat(l.stops), D(this.stops, function(f, d) { l.stops[d] = [l.stops[d][0], f.get(a)] })):l = h && C(h[0]) ? 'rgb' === a || !a && h[3]===1 ? 'rgb(' + h[0] + ',' + h[1] + ',' + h[2] + ')':'a' === a ? h[3]:'rgba(' + h.join(',') + ')':f; return l
 },
 brighten: function(a) { var f, v = this.rgba; if(this.stops)D(this.stops, function(l) { l.brighten(a) }); else if(C(a) && a!==0)for(f = 0; f<3; f++)v[f] += h(255 * a), v[f]<0 && (v[f] = 0), v[f]>255 && (v[f] = 255); return this },
setOpacity: function(a) { this.rgba[3] = a; return this }}; a.color = function(f) { return new a.Color(f) }
})(L);
  (function(a) {
var D, C, G = a.addEvent, I = a.animate, h = a.attr, f = a.charts, p = a.color, v = a.css, l = a.createElement, u = a.defined, d = a.deg2rad, c = a.destroyObjectProperties, n = a.doc, y = a.each, t = a.extend, m = a.erase, b = a.grep, q = a.hasTouch, z = a.isArray, F = a.isFirefox, e = a.isMS, r = a.isObject, x = a.isString, A = a.isWebKit, k = a.merge, w = a.noop, K = a.pick, J = a.pInt, N = a.removeEvent, g = a.stop, B = a.svg, S = a.SVG_NS, M = a.symbolSizes, R = a.win; D = a.SVGElement = function() { return this }; D.prototype = {opacity: 1,
SVG_NS: S,
 textProps: 'direction fontSize fontWeight fontFamily fontStyle color lineHeight width textDecoration textOverflow textOutline'.split(' '),
  init: function(a, H) { this.element = 'span' === H ? l(H):n.createElementNS(this.SVG_NS, H); this.renderer = a },
 animate: function(E, H, g) { H = a.animObject(K(H, this.renderer.globalAnimation, !0)); H.duration!==0 ? (g && (H.complete = g), I(this, E, H)):this.attr(E, null, g); return this },
colorGradient: function(E, H, g) {
 ...
 B = E[b]; m = e.gradients; q = E.stops; n = g.radialReference; z(B) && (E[b] = B = {x1: B[0],
 y1: B[1],
 x2: B[2],
  y2: B[3],
 gradientUnits: 'userSpaceOnUse'}); 'radialGradient' === b && n && !u(B.gradientUnits) && (r = B, B = k(B, e.getRadialAttr(n, r), {gradientUnits: 'userSpaceOnUse'})); for(P in B)'id' !== P && t.push(P, B[P]); for(P in q)t.push(q[P]); t = t.join(','); m[t] ? n = m[t].attr('id'):(B.id = n = a.uniqueKey(), m[t] = w = e.createElement(b).attr(B).add(e.defs), w.radAttr = r, w.stops = [], y(q, function(E) {
E[1].indexOf("rgba")===0 ? (c = a.color(E[1]), d = c.get('rgb'), x = c.get('a')):(d = E[1], x = 1); E = e.createElement('stop').attr({offset: E[0],
'stop-color': d,
...
var E = this.element, g, e, k, b; a.indexOf("contrast")!==-1 && (a = a.replace(/contrast/g, this.renderer.getContrast(E.style.fill))); this.fakeTS = !0; this.ySetter = this.xSetter; g = [].slice.call(E.getElementsByTagName('tspan')); a = a.split(' '); e = a[a.length - 1]; (k = a[0]) && 'none' !== k && (k = k.replace(/(^[\d\.]+)(.*?)$/g, function(a, E, H) { return 2 * E + H }), y(g, function(a) {
 'highcharts-text-outline' ===
a.getAttribute('class') && m(g, E.removeChild(a))
 }), b = E.firstChild, y(g, function(a, H) { H===0 && (a.setAttribute('x', E.getAttribute('x')), H = E.getAttribute('y'), a.setAttribute('y', H || 0), H===null && E.setAttribute('y', 0)); a = a.cloneNode(1); h(a, {'class': 'highcharts-text-outline', fill: e, stroke: e, 'stroke-width': k, 'stroke-linejoin': 'round'}); E.insertBefore(a, b) }))
 },
...
H, g) { for(var E = this.shadows, e = E.length; e--;)g.call(E[e], 'height' === a ? Math.max(H - (E[e].cutHeight || 0), 0):'d' === a ? this.d:H, a, E[e]) },
 addClass: function(a, H) { var E = this.attr('class') || ''; E.indexOf(a)===-1 && (H || (a = (E + (E ? ' ':'') + a).replace('  ', ' ')), this.attr('class', a)); return this },
hasClass: function(a) { returnh(this.element,"class").indexOf(a)!==-1 },
...
on: function(a, g) { var E = this, e = E.element; q && 'click' === a ? (e.ontouchstart = function(a) { E.touchEventFired = Date.now(); a.preventDefault(); g.call(e, a) }, e.onclick = function(a) { (R.navigator.userAgent.indexOf("Android")===-1 || Date.now()-(E.touchEventFired||0)>1100) && g.call(e, a) }):e['on' + a] = g; return this },
...
getBBox: function(a, g) {
 var E, H = this.renderer, k, b = this.element, c = this.styles, B, r = this.textStr, m, w = H.cache, q = H.cacheKeys,
  x; g = K(g, this.rotation); k = g * d; B = c && c.fontSize; void 0 !== r && (x = r.toString(), x.indexOf("\x3c")===-1 && (x = x.replace(/[0-9]/g, '0')), x += ['', g || 0, B, b.style.width, b.style['text-overflow']].join()); x && !a && (E = w[x]); if(!E) {
if(b.namespaceURI === this.SVG_NS || H.forExport) {
 try{ (m = this.fakeTS && function(a) { y(b.querySelectorAll('.highcharts-text-outline'), function(g) { g.style.display = a }) }) && m('none'), E = b.getBBox ? t({}, b.getBBox()):{width: b.offsetWidth, height: b.offsetHeight}, m && m('') }catch(T) {}if(!E || E.width<0){E={width:0,
height:0}}
}else E = this.htmlGetBBox(); H.isSVG && (a = E.width, H = E.height, e && c && '11px' === c.fontSize && '16.9' === H.toPrecision(3) && (E.height = H = 14), g && (E.width = Math.abs(H * Math.sin(k)) + Math.abs(a * Math.cos(k)), E.height = Math.abs(H * Math.cos(k)) + Math.abs(a * Math.sin(k)))); if(x && E.height>0) { for(;q.length>250;)delete w[q.shift()]; w[x] || q.push(x); w[x] = E }
}return E
},
...
this; g.animate({opacity: 0}, {duration: a || 150, complete: function() { g.attr({y: -9999}) }})
 ...
 add: function(a) { var g = this.renderer, e = this.element, E; a && (this.parentGroup = a); this.parentInverted = a && a.inverted; void 0 !== this.textStr && g.buildText(this); this.added = !0; if(!a || a.handleZ || this.zIndex)E = this.zIndexSetter(); E || (a ? a.element:g.box).appendChild(e); if(this.onAdd)this.onAdd(); return this },
safeRemoveChild: function(a) { var g = a.parentNode; g && g.removeChild(a) },
 destroy: function() {
var a = this.element || {}, e = this.renderer.isSVG &&
'SPAN' === a.nodeName && this.parentGroup, k, b; a.onclick = a.onmouseout = a.onmouseover = a.onmousemove = a.point = null; g(this); this.clipPath && (this.clipPath = this.clipPath.destroy()); if(this.stops) { for(b = 0; b < this.stops.length; b++)this.stops[b] = this.stops[b].destroy(); this.stops = null }this.safeRemoveChild(a); for(this.destroyShadows(); e && e.div && e.div.childNodes.length===0;)a = e.parentGroup, this.safeRemoveChild(e.div), delete e.div, e = a; this.alignTo && m(this.renderer.alignedObjects, this); for(k in this)delete this[k]; return null
},
...
destroyShadows: function() { y(this.shadows || [], function(a) { this.safeRemoveChild(a) }, this); this.shadows = void 0 },
...
a); this[g] = a
 ...
 dashstyleSetter: function(a) { var g, e = this['stroke-width']; 'inherit' === e && (e = 1); if(a = a && a.toLowerCase()) { a = a.replace('shortdashdotdot', '3,1,1,1,1,1,').replace('shortdashdot', '3,1,1,1').replace('shortdot', '1,1,').replace('shortdash', '3,1,').replace('longdash', '8,3,').replace(/dot/g, '1,3,').replace('dash', '4,3,').replace(/,$/, '').split(','); for(g = a.length; g--;)a[g] = J(a[g]) * e; a = a.join(',').replace(/NaN/g, 'none'); this.element.setAttribute('stroke-dasharray', a) } },
alignSetter: function(a) {
this.element.setAttribute('text-anchor',
{left: 'start', center: 'middle', right: 'end'}[a])
},
 opacitySetter: function(a, g, e) { this[g] = a; e.setAttribute(g, a) },
titleSetter: function(a) { var g = this.element.getElementsByTagName('title')[0]; g || (g = n.createElementNS(this.SVG_NS, 'title'), this.element.appendChild(g)); g.firstChild && g.removeChild(g.firstChild); g.appendChild(n.createTextNode(String(K(a), '').replace(/<[^>]*>/g, ''))) },
...
k),H=!0);} H || b.appendChild(B)
 ...
 _defaultSetter: function(a, g, e) { e.setAttribute(g, a) }}; D.prototype.yGetter = D.prototype.xGetter; D.prototype.translateXSetter = D.prototype.translateYSetter = D.prototype.rotationSetter = D.prototype.verticalAlignSetter = D.prototype.scaleXSetter = D.prototype.scaleYSetter = function(a, g) { this[g] = a; this.doTransform = !0 }; D.prototype['stroke-widthSetter'] = D.prototype.strokeSetter = function(a, g, e) {
this[g] = a; this.stroke && this['stroke-width'] ? (D.prototype.fillSetter.call(this, this.stroke,
'stroke', e), e.setAttribute('stroke-width', this['stroke-width']), this.hasStroke = !0):'stroke-width' === g && a===0 && this.hasStroke && (e.removeAttribute('stroke'), this.hasStroke = !1)
}; C = a.SVGRenderer = function() { this.init.apply(this, arguments) }; C.prototype = {Element: D,
SVG_NS: S,
init: function(a, g, e, k, b, c) {
 var B; k = this.createElement('svg').attr({version: '1.1', 'class': 'highcharts-root'}).css(this.getStyle(k)); B = k.element; a.appendChild(B); a.innerHTML.indexOf("xmlns")===-1 && h(B, 'xmlns', this.SVG_NS); this.isSVG = !0
...
for(var g = a.element, e = this, k = e.forExport, c = K(a.textStr, '').toString(), r = c.indexOf("\x3c")!==-1, m = g.childNodes, w, E, q, x, d = h(g, 'x'), t = a.styles, A = a.textWidth, z = t &&
t.lineHeight, l = t && t.textOutline, F = t && 'ellipsis' === t.textOverflow, f = m.length, u = A && !a.added && this.box, p = function(a) { var k; k = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize:t && t.fontSize || e.style.fontSize || 12; return z ? J(z):e.fontMetrics(k, a.getAttribute('style') ? a:g).h }; f--;)g.removeChild(m[f]); r || l || F || A || c.indexOf(" ")!==-1 ? (w = /<.*class="([^"]+)".*>/, E = /<.*style="([^"]+)".*>/, q = /<.*href="(http[^"]+)".*>/, u && u.appendChild(g), c = r ? c.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g,
...
l.appendChild(n.createTextNode(b)); H ? m.dx = 0:c && d!==null && (m.x = d); h(l, m); g.appendChild(l); !H && c && (!B && k && v(l, {display: 'block'}), h(l, 'dy', p(l))); if(A) {
 m = b.replace(/([^\^])-/g, '$1- ').split(' '); z = 'nowrap' === t.whiteSpace; for(var K = r.length>1 || c || m.length>1 && !z, u, y, J = [], M = p(l), P = a.rotation,
...
l.appendChild(n.createTextNode(m.join(" ").replace(/- /g,"-")));} a.rotation = P
 ...
 getContrast: function(a) { a = p(a).rgba; return a[0]+a[1]+a[2]>510 ? '#000000':'#FFFFFF' },
...
var H = this.label(a, g, b, q, null, null, null, null, 'button'), E = 0; H.attr(k({padding: 8, r: 2}, B)); var x, d, n, l; B = k({fill: '#f7f7f7',
  stroke: '#cccccc',
 'stroke-width': 1,
style: {color: '#333333', cursor: 'pointer', fontWeight: 'normal'}}, B); x = B.style; delete B.style; r = k(B, {fill: '#e6e6e6'}, r); d = r.style; delete r.style; m = k(B, {fill: '#e6ebf5', style: {color: '#000000', fontWeight: 'bold'}}, m); n = m.style; delete m.style; w = k(B, {style: {color: '#cccccc'}}, w); l = w.style; delete w.style; G(H.element, e ? 'mouseover':'mouseenter', function() { E!==3 && H.setState(1) }); G(H.element, e ? 'mouseout':'mouseleave', function() { E!==3 && H.setState(E) }); H.setState = function(a) {
a!==1 &&
...
}; H.attr(B).css(t({cursor: 'default'}, x)); return H.on('click', function(a) { E!==3 && c.call(H, a) })
},
crispLine: function(a, g) { a[1] === a[4] && (a[1] = a[4] = Math.round(a[1]) - g % 2 / 2); a[2] === a[5] && (a[2] = a[5] = Math.round(a[2]) + g % 2 / 2); return a },
 path: function(a) { var g = {fill: 'none'}; z(a) ? g.d = a:r(a) && t(g, a); return this.createElement('path').attr(g) },
  circle: function(a, g, e) { a = r(a) ? a:{x: a, y: g, r: e}; g = this.createElement('circle'); g.xSetter = g.ySetter = function(a, g, e) { e.setAttribute('c' + g, a) }; return g.attr(a) },
arc: function(a, g, e, b, k, c) { r(a) && (g = a.y, e = a.r, b = a.innerR, k = a.start, c = a.end, a = a.x); a = this.symbol('arc', a || 0, g || 0, e || 0, e || 0, {innerR: b || 0, start: k || 0, end: c || 0}); a.r = e; return a },
...
setSize: function(a, g, e) { var b = this.alignedObjects, k = b.length; this.width = a; this.height = g; for(this.boxWrapper.animate({width: a, height: g}, {step: function() { this.attr({viewBox: '0 0 ' + this.attr('width') + ' ' + this.attr('height')}) }, duration: K(e, !0) ? void 0:0}); k--;)b[k].align() },
...
var a =
f[B.chartIndex]; this.width===0 && (v(this, {position: 'absolute', top: '-999em'}), n.body.appendChild(this)); M[q] = {width: this.width, height: this.height}; r.imgwidth = this.width; r.imgheight = this.height; r.element && x(); this.parentNode && this.parentNode.removeChild(this); B.imgCount--; if(!B.imgCount && a && a.onload)a.onload()
},
 src: q}), this.imgCount++)); return r
 },
 symbols: {circle: function(a, g, e, b) { var k = 0.166 * e; return['M', a + e / 2, g, 'C', a + e + k, g, a + e + k, g + b, a + e / 2, g + b, 'C', a - k, g + b, a - k, g, a + e / 2, g, 'Z'] },
...
var c = k.start; e = k.r || e || b; var B = k.end - 0.001; b = k.innerR; var r = k.open, m = Math.cos(c), H = Math.sin(c), w = Math.cos(B), B = Math.sin(B); k = k.end - c < Math.PI ? 0:1; return['M', a + e * m, g + e * H, 'A', e, e, 0, k, 1, a + e * w, g + e * B, r ? 'M':'L', a + b * w, g + b * B,
  'A', b, b, 0, k, 0, a + b * m, g + b * H, r ? '':'Z']
 },
callout: function(a, g, e, b, k) {
 var c = Math.min(k && k.r || 0, e, b), B = c + 6, r = k && k.anchorX; k = k && k.anchorY; var m; m = ['M', a + c, g, 'L', a + e - c, g, 'C', a + e, g, a + e, g, a + e, g + c, 'L', a + e, g + b - c, 'C', a + e, g + b, a + e, g + b, a + e - c, g + b, 'L', a + c, g + b, 'C', a, g + b, a, g + b, a, g + b - c, 'L', a, g + c, 'C', a, g, a, g, a + c, g]; r && r > e ? k > g + B && k < g + b - B ? m.splice(13, 3, 'L', a + e, k - 6, a + e + 6, k, a + e, k + 6, a + e, g + b - c):m.splice(13, 3, 'L', a + e, b / 2, r, k, a + e, b / 2, a + e, g + b - c):r && r<0 ? k > g + B && k < g + b - B ? m.splice(33, 3, 'L', a, k + 6, a - 6, k, a, k - 6, a, g + c):m.splice(33, 3, 'L',
a, b / 2, r, k, a, b / 2, a, g + c):k && k > b && r > a + B && r < a + e - B ? m.splice(23, 3, 'L', r + 6, g + b, r, g + b + 6, r - 6, g + b, a + c, g + b):k && k<0 && r > a + B && r < a + e - B && m.splice(3, 3, 'L', r - 6, g, r, g - 6, r + 6, g, e - c, g); return m
}},
 clipRect: function(g, e, b, k) { var c = a.uniqueKey(), B = this.createElement('clipPath').attr({id: c}).add(this.defs); g = this.rect(g, e, b, k, 0).add(B); g.id = c; g.clipPath = B; g.count = 0; return g },
...
if(a || a===0)c.text = a; a = this.createElement('text').attr(c); k && a.css({position: 'absolute'}); b || (a.xSetter = function(a, g, e) { var b = e.getElementsByTagName('tspan'), k, c = e.getAttribute(g), B; for(B = 0; B < b.length; B++)k = b[B], k.getAttribute(g) === c && k.setAttribute(g, a); e.setAttribute(g, a) }); return a
},
fontMetrics: function(a, g) {
 a = a || g && g.style && g.style.fontSize || this.style && this.style.fontSize; a = /px/.test(a) ? J(a):/em/.test(a) ? parseFloat(a) * (g ? this.fontMetrics(null, g.parentNode).f:16):12; g = a<24 ? a + 3:Math.round(1.2 *
a); return{h: g, b: Math.round(0.8 * g), f: a}
 },
 rotCorr: function(a, g, e) { var b = a; g && e && (b = Math.max(b * Math.cos(g * d), 4)); return{x: -a / 3 * Math.sin(g * d), y: b} },
...
var a = z + A, g; g = m ? 0:S; u(F) && n && ('center' === J || 'right' === J) && (a += {center: 0.5, right: 1}[J] * (F - n.width)); if(a !== d.x || g !== d.y){d.attr("x",a),void 0!==g&&d.attr("y",
g);} d.x = a; d.y = g
}; Q = function(a, g) { H ? H.attr(a, g):h[a] = g }; x.onAdd = function() { d.add(x); x.attr({text: a || a===0 ? a:'', x: g, y: e}); H && u(c) && x.attr({anchorX: c, anchorY: B}) }; x.widthSetter = function(a) { F = a }; x.heightSetter = function(a) { f = a }; x['text-alignSetter'] = function(a) { J = a }; x.paddingSetter = function(a) { u(a) && a !== A && (A = x.padding = a, O()) }; x.paddingLeftSetter = function(a) { u(a) && a !== z && (z = a, O()) }; x.alignSetter = function(a) { a = {left: 0, center:0 .5, right: 1}[a]; a !== l && (l = a, n && x.attr({x: K})) }; x.textSetter = function(a) {
void 0 !==
...
{}; a = k(a); y(x.textProps, function(e) { void 0 !== a[e] && (g[e] = a[e], delete a[e]) }); d.css(g)
 ...
 destroy: function() { N(x.element, 'mouseenter'); N(x.element, 'mouseleave'); d && (d = d.destroy()); H && (H = H.destroy()); D.prototype.destroy.call(x); x = q = R = O = Q = null }})
 }}; a.Renderer = C
})(L); (function(a) {
var D = a.attr, C = a.createElement, G = a.css, I = a.defined, h = a.each, f = a.extend, p =
a.isFirefox, v = a.isMS, l = a.isWebKit, u = a.pInt, d = a.SVGRenderer, c = a.win, n = a.wrap; f(a.SVGElement.prototype, {htmlCss: function(a) { var c = this.element; if(c = a && 'SPAN' === c.tagName && a.width)delete a.width, this.textWidth = c, this.updateTransform(); a && 'ellipsis' === a.textOverflow && (a.whiteSpace = 'nowrap', a.overflow = 'hidden'); this.styles = f(this.styles, a); G(this.element, a); return this },
...
var b = {},
 ...
 getSpanCorrection: function(a, c, m) { this.xCorr = -a * m; this.yCorr = -c }}); f(d.prototype, {html: function(a, c, m) {
...
var m, x = D(a.element, 'class'); x && (x = {className: x}); c = a.div = a.div || C('div', x, {position: 'absolute', left: (a.translateX || 0) + 'px', top: (a.translateY || 0) + 'px', display: a.display, opacity: a.opacity, pointerEvents: a.styles && a.styles.pointerEvents}, c || r); m = c.style; f(a, {on: function() { b.on.apply({element: k[0].div}, arguments); return a },
translateXSetter: function(e, g) { m.left = e + 'px'; a[g] = e; a.doTransform = !0 },
...
e + 'px'; a[g] = e; a.doTransform = !0
 ...
 var D, C, G = a.createElement, I = a.css, h = a.defined, f = a.deg2rad, p = a.discardElement, v = a.doc, l = a.each, u = a.erase, d = a.extend; D = a.extendClass; var c = a.isArray, n = a.isNumber, y = a.isObject, t = a.merge; C = a.noop; var m = a.pick, b = a.pInt, q = a.SVGElement, z = a.SVGRenderer, F = a.win; a.svg || (C = {docMode8: v && v.documentMode===8,
 init: function(a, b) {
...
if(this.onAdd)this.onAdd(); this.className && this.attr('class', this.className); return this
 ...
 setSpanRotation: function() { var a = this.rotation, b = Math.cos(a * f), c = Math.sin(a * f); I(this.element, {filter: a ? ['progid:DXImageTransform.Microsoft.Matrix(M11\x3d', b, ', M12\x3d', -c, ', M21\x3d', c, ', M22\x3d', b, ", sizingMethod\x3d'auto expand')"].join(''):'none'}) },
...
var e = q ? Math.cos(q * f):1, r = q ? Math.sin(q * f):0, x = m(this.elemHeight, this.element.offsetHeight),
  d; this.xCorr = e<0 && -a; this.yCorr = r<0 && -x; d = e*r<0; this.xCorr += r * b * (d ? 1 - c:c); this.yCorr -= e * b * (q ? d ? c:1 - c:1); k && 'left' !== k && (this.xCorr -= a * c * (e<0 ? -1:1), q && (this.yCorr -= x * c * (r<0 ? -1:1)), I(this.element, {textAlign: k}))
 },
...
on: function(a, b) { this.element['on' + a] = function() { var a = F.event; a.target = a.srcElement; b(a) }; return this },
 cutOffPath: function(a, c) {
 var e; a = a.split(/[ ,]/)
e = a.length; if(e===9 || e===11)a[e - 4] = a[e - 2] = b(a[e - 2]) - 10 * c; return a.join(' ')
 },
...
var e = [], k, r = this.element, d = this.renderer, x, n = r.style, g, B = r.path, l, t, z, f; B && 'string' !== typeof B.value && (B = 'x'); t = B; if(a) {
 z = m(a.width, 3); f = (a.opacity || 0.15) / z; for(k = 1; k<=3; k++){l=2*z+1-2*k,q&&(t=this.cutOffPath(B.value,l+.5)),g=['\x3cshape isShadow\x3d"true" strokeweight\x3d"',l,'" filled\x3d"false" path\x3d"',t,'" coordsize\x3d"10 10" style\x3d"',r.style.cssText,'" /\x3e'],x=G(d.prepVML(g),null,{left:b(n.left)+
m(a.offsetX,1),top:b(n.top)+m(a.offsetY,1)}),q&&(x.cutOff=l+1),g=['\x3cstroke color\x3d"',a.color||"#000000",'" opacity\x3d"',f*k,'"/\x3e'],G(d.prepVML(g),null,null,x),c?c.element.appendChild(x):r.parentNode.insertBefore(x,r),e.push(x);} this.shadows = e
}return this
},
 updateShadows: C,
...
dSetter: function(a, b, c) { var e = this.shadows; a = a || []; this.d = a.join && a.join(' '); c.path = a = this.pathToVML(a); if(e)for(c = e.length; c--;)e[c].path = e[c].cutOff ? this.cutOffPath(a, e[c].cutOff):a; this.setAttr(b, a) },
...
xSetter: function(a, b, c) { this[b] = a; 'x' === b ? b = 'left':'y' === b && (b = 'top'); this.updateClipping ? (this[b] = a, this.updateClipping()):c.style[b] = a },
zIndexSetter: function(a, b, c) { c.style[b] = a }}, C['stroke-opacitySetter'] = C['fill-opacitySetter'], a.VMLElement = C = D(q, C), C.prototype.ySetter = C.prototype.widthSetter = C.prototype.heightSetter =
C.prototype.xSetter, C = {Element: C,
 isIE8: F.navigator.userAgent.indexOf("MSIE 8.0")>-1,
 init: function(a, b, c) {
...
var e = this.createElement(), r = y(a); return d(e, {members: [],
count: 0,
left: (r ? a.x:a) + 1,
top: (r ? a.y:b) + 1,
 width: (r ? a.width:c) - 1,
...
k:e) + 'px,' + Math.round(g ? m:b) + 'px,' + Math.round(g ? b:m) + 'px,' + Math.round(g ? e:k) + 'px)'}; !g && a.docMode8 && 'DIV' === c && d(e, {width: b + 'px', height: m + 'px'}); return e
},
...
'" opacity\x3d"', H, '" o:opacity2\x3d"', F, '" type\x3d"', x, '" ', p, 'focus\x3d"100%" method\x3d"any" /\x3e']; G(e.prepVML(n), null, null, c)
 }; f = b[0]; h = b[b.length - 1]; f[0]>0 && b.unshift([0, f[1]]); h[0]<1 && b.push([1, h[1]]); l(b, function(g, b) { d.test(g[1]) ? (r = a.color(g[1]), B = r.get('rgb'), t = r.get('a')):(B = g[1], t = 1); y.push(100 * g[0] + '% ' + B); b ? (H = t, A = B):(F = t, u = B) }); if('fill' === m){if("gradient"===x)m=z.x1||z[0]||0,b=z.y1||z[1]||0,f=z.x2||z[2]||0,z=z.y2||z[3]||0,p='angle\x3d"'+(90-180*Math.atan((z-b)/(f-m))/Math.PI)+'"',
...
g.length&&(g[0].opacity=1,g[0].type="solid"),g=b);} return g
 ...
 prepVML: function(a) { var b = this.isIE8; a = a.join(''); b ? (a = a.replace('/\x3e', ' xmlns\x3d"urn:schemas-microsoft-com:vml" /\x3e'), a = a.indexOf('style\x3d"')===-1 ? a.replace('/\x3e', ' style\x3d"display:inline-block;behavior:url(#default#VML);" /\x3e'):a.replace('style\x3d"', 'style\x3d"display:inline-block;behavior:url(#default#VML);')):a = a.replace('\x3c', '\x3chcv:'); return a },
 text: z.prototype.html,
 path: function(a) {
var b = {coordsize: '10 10'}; c(a) ? b.d =
a:y(a) && d(b, a); return this.createElement('shape').attr(b)
 },
 circle: function(a, b, c) { var e = this.symbol('circle'); y(a) && (c = a.r, b = a.y, a = a.x); e.isCircle = !0; e.r = c; return e.attr({x: a, y: b}) },
g: function(a) { var b; a && (b = {className: 'highcharts-' + a, 'class': 'highcharts-' + a}); return this.createElement('div').attr(b) },
 image: function(a, b, c, m, k) { var e = this.createElement('img').attr({src: a}); arguments.length>1 && e.attr({x: b, y: c, width: m, height: k}); return e },
createElement: function(a) {
 return'rect' === a ? this.symbol(a):z.prototype.createElement.call(this,
a)
 },
invertChild: function(a, c) { var e = this; c = c.style; var m = 'IMG' === a.tagName && a.style; I(a, {flip: 'x', left: b(c.width) - (m ? b(m.top):1), top: b(c.height) - (m ? b(m.left):1), rotation: -90}); l(a.childNodes, function(b) { e.invertChild(b, a) }) },
symbols: {arc: function(a, b, c, m, k) {
 var e = k.start, q = k.end, d = k.r || c || m; c = k.innerR; m = Math.cos(e); var r = Math.sin(e), g = Math.cos(q), B = Math.sin(q); if(q-e===0)return['x']; e = ['wa', a - d, b - d, a + d, b + d, a + d * m, b + d * r, a + d * g, b + d * B]; k.open && !c && e.push('e', 'M', a, b); e.push('at', a - c, b - c, a + c, b + c, a + c * g,
b + c * B, a + c * m, b + c * r, 'x', 'e'); e.isArc = !0; return e
 },
 circle: function(a, b, c, m, k) { k && h(k.r) && (c = m = 2 * k.r); k && k.isCircle && (a -= c / 2, b -= m / 2); return['wa', a, b, a + c, b + m, a + c, b + m / 2, a + c, b + m / 2, 'e'] },
 rect: function(a, b, c, m, k) { return z.prototype.symbols[h(k) && k.r ? 'callout':'square'].call(0, a, b, c, m, k) }}}, a.VMLRenderer = D = function() { this.init.apply(this, arguments) }, D.prototype = t(z.prototype, C), a.Renderer = D); z.prototype.measureSpanWidth = function(a, b) {
...
a
 ...
 }var C = a.color, G = a.each, I = a.getTZOffset, h = a.merge, f = a.pick, p = a.win; a.defaultOptions = {colors: '#7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1'.split(' '),
...
style: {color: '#333333',
 ...
 pointerEvents: 'none',
whiteSpace: 'nowrap'}},
credits: {enabled: !0, href: 'http://www.highcharts.com', position: {align: 'right', x: -10, verticalAlign: 'bottom', y: -5}, style: {cursor: 'pointer', color: '#999999', fontSize: '9px'}, text: ''}}; a.setOptions = function(f) { a.defaultOptions = h(!0, a.defaultOptions, f); D(); return a.defaultOptions }; a.getOptions = function() { return a.defaultOptions }; a.defaultPlotOptions = a.defaultOptions.plotOptions; D()
 })(L); (function(a) {
...
(r?(F.show(),F.animate({d:r})):(F.hide(),h&&(a.label=h=h.destroy())));} n && G(n.text) && r && r.length && f.width>0 && f.height>0 && !r.flat ? (n = p({align: d && q && 'center', x: d ? !q && 4:10, verticalAlign: !d && q && 'middle', y: d ? q ? 16:10:q ? 6:-4, rotation: d && !q && 90}, n), this.renderLabel(n, r, q, k)):h && h.hide(); return a
},
...
this.label = n = l.text(a.text, 0, 0, a.useHTML).attr(n).add(), n.css(a.style)); c = [f[1], f[4], d ? f[6]:f[1]]; f = [f[2], f[5], d ? f[7]:f[2]]; d = C(c); l = C(f); n.align(a, !1, {x: d, y: l, width: D(c) - d, height: D(f) - l}); n.show()
 ...
 destroy: function() { f(this.axis.plotLinesAndBands, this); delete this.axis; I(this) }}; a.AxisPlotLineOrBandExtension = {getPlotBandPath: function(a, f) {
...
return a
 ...
 addPlotBandOrLine: function(f, h) { var d = (new a.PlotLineOrBand(this, f)).render(), c = this.userOptions; d && (h && (c[h] = c[h] || [], c[h].push(f)), this.plotLinesAndBands.push(d)); return d },
...
getPosition: function(a, f, h, d) {
 var c = this.axis, n = c.chart, l = d && n.oldChartHeight || n.chartHeight; return{x: a ? c.translate(f + h, null, null, d) + c.transB:c.left + c.offset + (c.opposite ? (d && n.oldChartWidth || n.chartWidth) - c.right - c.left:0),
y: a ? l - c.bottom + c.offset - (c.opposite ? c.height:0):l - c.translate(f + h, null,
null, d) - c.transB}
 },
getLabelPosition: function(a, f, h, d, c, n, y, t) { var m = this.axis, b = m.transA, q = m.reversed, z = m.staggerLines, l = m.tickRotCorr || {x: 0, y: 0}, e = c.y; C(e) || (e = m.side===0 ? h.rotation ? -8:-h.getBBox().height:m.side===2 ? l.y + 8:Math.cos(h.rotation * p) * (l.y - h.getBBox(!1, 0).height / 2)); a = a + c.x + l.x - (n && d ? n * b * (q ? -1:1):0); f = f + e - (n && !d ? n * b * (q ? 1:-1):0); z && (h = y / (t || 1) % z, m.opposite && (h = z - h - 1), f += m.labelOffset / z * h); return{x: a, y: Math.round(f)} },
...
g, p, n),
 opacity: h})); m && I(u) && (m.xy = J = this.getLabelPosition(u, J, m, p, q, K, a, A), this.isFirst && !this.isLast && !f(c.showFirstLabel, 1) || this.isLast && !this.isFirst && !f(c.showLastLabel, 1) ? w = !1:!p || d.isRadial || q.step || q.rotation || l || h===0 || this.handleOverflow(J), A && a % A && (w = !1), w && I(J.y) ? (J.opacity = h, m[this.isNew ? 'attr':'animate'](J)):m.attr('y', -9999), this.isNew = !1)
 },
...
defaultYAxisOptions: {endOnTick: !0, tickPixelInterval: 72, showLastLabel: !0, labels: {x: -8}, maxPadding:0 .05, minPadding: 0.05, startOnTick: !0, title: {rotation: 270, text: 'Values'}, stackLabels: {enabled: !1, formatter: function() { return a.numberFormat(this.total, -1) }, style: {fontSize: '11px', fontWeight: 'bold', color: '#000000', textOutline: '1px contrast'}}, gridLineWidth: 1, lineWidth: 0},
 ...
 defaultRightAxisOptions: {labels: {x: 15},
  title: {rotation: 90}},
...
this.isLog && (this.val2lin = this.log2lin, this.lin2val = this.lin2log)
 ...
 var g = this.axis, b = this.value, c = g.categories, e = this.dateTimeLabelFormat, k = v.lang, m = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, q = m && m.length, d, r = g.options.labels.format,
  g = g.isLog ? b:g.tickInterval; if(r)d = t(r, this); else if(c)d = b; else if(e)d = a.dateFormat(e, b); else if(q && g>=1E3)for(;q-- && void 0 === d;)c = Math.pow(k, q + 1), g >= c && 10*b%c===0 && m[q]!==null && b!==0 && (d = a.numberFormat(b / c, -1) + m[q]); void 0 === d && (d = Math.abs(b)>=1E4 ? a.numberFormat(b, -1):a.numberFormat(b, -1, void 0, '')); return d
 },
...
var g = this.chart, B = this.left, m = this.top, q, d, r = c && g.oldChartHeight || g.chartHeight, n = c && g.oldChartWidth || g.chartWidth, f; q = this.transB; var w = function(a, g, b) { if(a < g || a > b)e ? a = Math.min(Math.max(g, a), b):f = !0; return a }; k = A(k, this.translate(a, null, null, c)); a = c = Math.round(k + q); q = d = Math.round(r - k - q); F(k) ? this.horiz ? (q = m, d = r - this.bottom, a = c = w(a, B, B + this.width)):(a = B, c = n - this.right, q = d = w(q, m, m + this.height)):f = !0; return f && !e ? null:g.renderer.crispLine(['M',
 ...
 getLinearTickPositions: function(a, b, c) { var g, k = p(Math.floor(b / a) * a), e = p(Math.ceil(c / a) * a), B = []; if(b === c && F(b))return[b]; for(b = k; b <= e;) { B.push(b); b = p(b + a); if(b === g)break; g = b }return B },
...
"auto"===a.minorTickInterval)k=k.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c),e,m,a.startOfWeek));else for(b=e+(b[0]-e)%c;b<=m&&b!==k[0];b+=c)k.push(b);} k.length!==0 && this.trimTicks(k, a.startOnTick, a.endOnTick); return k
},
...
1:f.length - 1; d>0; d--)if(r = f[d] - f[d - 1], void 0 === q || r < q)q = r
...
nameToX: function(a) { var b = z(this.categories), g = b ? this.categories:this.names, c = a.options.x, k; a.series.requireSorting = !1; l(c) || (c = !1 === this.options.uniqueNames ? a.series.autoIncrement():q(a.name, g)); c===-1 ? b || (k = g.length):k = c; this.names[k] = a.name; return k },
 updateNames: function() {
 var a = this; this.names.length>0 && (this.names.length = 0, this.minRange = void 0, c(this.series || [], function(b) {
 b.xIncrement =
...
var b = this, g = b.max - b.min, k = b.axisPointRange || 0, m, q = 0, d = 0, r = b.linkedParent, f = !!b.categories, n = b.transA, w = b.isXAxis; if(w || f || k){m=b.getClosest(),r?(q=r.minPointOffset,d=r.pointRangePadding):c(b.series,function(a){var g=f?1:w?A(a.options.pointRange,m,0):b.axisPointRange||0;a=a.options.pointPlacement;
k=Math.max(k,g);b.single||(q=Math.max(q,e(a)?0:g/2),d=Math.max(d,"on"===a?0:g))}),r=b.ordinalSlope&&m?b.ordinalSlope/m:1,b.minPointOffset=q*=r,b.pointRangePadding=d*=r,b.pointRange=Math.min(k,g),w&&(b.closestPointRange=m);} a && (b.oldTransA = n); b.translationSlope = b.transA = n = b.len / (g + d || 1); b.transB = b.horiz ? b.left:b.bottom; b.minPixelPadding = n * q
 },
...
g.oldMax)
}); g.setAxisTranslation(!0); g.beforeSetTickPositions && g.beforeSetTickPositions(); g.postProcessTickInterval && (g.tickInterval = g.postProcessTickInterval(g.tickInterval)); g.pointRange && !z && (g.tickInterval = Math.max(g.pointRange, g.tickInterval)); b = A(e.minTickInterval, g.isDatetimeAxis && g.closestPointRange); !z && g.tickInterval < b && (g.tickInterval = b); r || q || z || (g.tickInterval = x(g.tickInterval, null, m(g.tickInterval), A(e.allowDecimals, !(0g.tickInterval>.5 && g.tickInterval<5 && g.max>1E3 && g.max<9999)), !!this.tickAmount))
this.tickAmount || (g.tickInterval = g.unsquish()); this.setTickPositions()
 },
 setTickPositions: function() {
 var a = this.options, b, c = a.tickPositions, k = a.tickPositioner, e = a.startOnTick, m = a.endOnTick, q; this.tickmarkOffset = this.categories && 'between' === a.tickmarkPlacement && this.tickInterval===1 ? 0.5:0; this.minorTickInterval = 'auto' === a.minorTickInterval && this.tickInterval ? this.tickInterval / 5:a.minorTickInterval; this.tickPositions = b = c && c.slice(); !b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval,
a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0):this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max):this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b[0], b.pop()]), this.tickPositions = b, k && (k = k.apply(this, [this.min, this.max]))) && (this.tickPositions = b = k); this.isLinked || (this.trimTicks(b, e, m), this.min === this.max && l(this.min) && !this.tickAmount && (q = !0, this.min -= 0.5, this.max += 0.5), this.single = q, c || k || this.adjustTickAmount())
},
  trimTicks: function(a, b, c) { var g = a[0], k = a[a.length - 1], e = this.minPointOffset || 0; if(b)this.min = g; else for(;this.min - e > a[0];)a.shift(); if(c)this.max = k; else for(;this.max + e < a[a.length - 1];)a.pop(); a.length===0 && l(g) && a.push((k + g) / 2) },
alignToOthers: function() { var a = {}, b, k = this.options; !1 === this.chart.options.chart.alignTicks || !1 === k.alignTicks || this.isLog || c(this.chart[this.coll], function(g) { var c = g.options, c = [g.horiz ? c.left:c.top, c.width, c.height, c.pane].join(); g.series.length && (a[c] ? b = !0:a[c] = 1) }); return b },
...
1]
 }else e > c && (this.tickInterval *= 2, this.setTickPositions()); if(l(k)) { for(a = c = b.length; a--;)(k===3 && a%2===1 || k<=2 && a>0 && a < c - 1) && b.splice(a, 1); this.finalTickAmt = void 0 }
 },
setScale: function() {
...
setExtremes: function(a, b, k, e, m) { var g = this, q = g.chart; k = A(k, !0); c(g.series, function(a) { delete a.kdTree }); m = n(m, {min: a, max: b}); y(g, 'setExtremes', m, function() { g.userMin = a; g.userMax = b; g.eventArgs = m; k && q.redraw(e) }) },
 zoom: function(a,
b) { var g = this.dataMin, c = this.dataMax, k = this.options, e = Math.min(g, A(k.min, g)), k = Math.max(c, A(k.max, c)); if(a !== this.min || b !== this.max)this.allowZoomOutside || (l(g) && (a < e && (a = e), a > k && (a = k)), l(c) && (b < e && (b = e), b > k && (b = k))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: 'zoom'}); return!0 },
...
a.plotLeft + c), c = /%$/; c.test(m) && (m = Math.round(parseFloat(m) / 100 * a.plotHeight)); c.test(q) && (q = Math.round(parseFloat(q) / 100 * a.plotHeight + a.plotTop)); this.left = b; this.top = q; this.width = e; this.height = m; this.bottom = a.chartHeight - m - q; this.right = a.chartWidth - e - b; this.len = Math.max(k ? e:m, 0); this.pos = k ? b:q
 ...
 getExtremes: function() { var a = this.isLog, b = this.lin2log; return{min: a ? p(b(this.min)):this.min, max: a ? p(b(this.max)):this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax} },
  getThreshold: function(a) { var b = this.isLog, g = this.lin2log, c = b ? g(this.min):this.min, b = b ? g(this.max):this.max; a===null ? a = c:c > a ? a = c:b < a && (a = b); return this.translate(a, 0, 1, 0, 1) },
autoLabelAlign: function(a) { a = (A(a, 0) - 90 * this.side + 720) % 360; return a>15 && a<165 ? 'right':a>195 && a<345 ? 'left':'center' },
 tickSize: function(a) { var b = this.options, g = b[a + 'Length'], c = A(b[a + 'Width'], 'tick' === a && this.isXAxis ? 1:0); if(c && g)return'inside' === b[a + 'Position'] && (g = -g), [g, c] },
...
this.options.labels.style.fontSize, this.ticks[0] && this.ticks[0].label)
 ...
 unsquish: function() {
 var a = this.options.labels, b = this.horiz, k = this.tickInterval, e = k, m = this.len / (((this.categories ? 1:0) + this.max - this.min) / k), q, d = a.rotation, r = this.labelMetrics(), f, n = Number.MAX_VALUE, w, t = function(a) { a /= m || 1; a = a>1 ? Math.ceil(a):1; return a * k }; b ? (w = !a.staggerLines && !a.step && (l(d) ? [d]:m < A(a.autoRotationLimit, 80) && a.autoRotation)) && c(w, function(a) {
 var b; if(a === d || a && a>=-90 && a<=90){f=t(Math.abs(r.h/Math.sin(u*a))),b=f+
Math.abs(a/360),b<n&&(n=b,q=a,e=f)}
 }):a.step || (e = t(r.h)); this.autoRotation = w; this.labelRotation = A(q, d); return e
 },
getSlotWidth: function() { var a = this.chart, b = this.horiz, c = this.options.labels, k = Math.max(this.tickPositions.length - (this.categories ? 0:1), 1), e = a.margin[3]; return b && (c.step||0)<2 && !c.rotation && (this.staggerLines || 1) * a.plotWidth / k || !b && (e && e - a.spacing[3] || 0.33 * a.chartWidth) },
...
m[F].labelLength>f&&n.css({width:f+"px"}),n.getBBox().height>this.len/k.length-(t.h-t.f)&&(n.specCss={textOverflow:"ellipsis"});} w.rotation && (h = {width: (l > 0.5 * a.chartHeight ? 0.33 * a.chartHeight:a.chartHeight) + 'px'}, z || (h.textOverflow = 'ellipsis')); if(this.labelAlign = q.align || this.autoLabelAlign(this.labelRotation))w.align = this.labelAlign; c(k, function(a) { var b = (a = m[a]) && a.label; b && (b.attr(w), h && b.css(r(h, b.specCss)), delete b.specCss, a.rotation = w.rotation) }); this.tickRotCorr = b.rotCorr(t.b, this.labelRotation ||
0, this.side!==0)
},
...
getLinePath: function(a) { var b = this.chart, c = this.opposite, g = this.offset, k = this.horiz, e = this.left + (c ? this.width:0) + g, g = b.chartHeight - this.bottom - (c ? this.height:0) + g; c && (a *= -1); return b.renderer.crispLine(['M', k ? this.left:e, k ? g:this.top, 'L', k ? b.chartWidth - this.right:e, k ? g:b.chartHeight - this.bottom], a) },
 renderLine: function() {
...
(q ? -1:1) * this.axisTitleMargin + (this.side===2 ? w:0); return{x: a ? k + r:b + (q ? this.width:0) + d + r, y: a ? b + n - (q ? this.height:0) + d:k + n}
},
render: function() {
...
g[k]=null;} c([b.ticks, b.minorTicks, b.alternateBands], function(a) { d(a) }); if(e)for(a = e.length; a--;)e[a].destroy(); c('stackTotalGroup axisLine axisTitle axisGroup gridGroup labelGroup cross'.split(' '), function(a) { b[a] && (b[a] = b[a].destroy()) }); for(m in b)b.hasOwnProperty(m) && q(m,b.keepProps)===-1 && delete b[m]
},
...
hideCrosshair: function() { this.cross && this.cross.hide() }}; n(a.Axis.prototype, h)
})(L); (function(a) {
...
var f = this.options, d = this.len, c = this.lin2log, n = this.log2lin, y = []; l || (this._minorAutoInterval = null); if(0a>=.5)a = Math.round(a), y = this.getLinearTickPositions(a, p, v); else if(0a>=.08){for(var d=Math.floor(p),t,m,
...
var c = this, b = c.now, q = !1 !== c.options.animation && !c.isHidden && (Math.abs(a-b.x)>1 || Math.abs(d-b.y)>1), n = c.followPointer || c.len>1; G(b, {x: q ? (2 * b.x + a) / 3:a,
y: q ? (b.y + d) / 2:d,
 anchorX: n ? void 0:q ? (2 * b.anchorX + f) / 3:f,
 anchorY: n ? void 0:q ? (b.anchorY +
t) / 2:t}); c.getLabel().attr(b); q && (clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() { c && c.move(a, d, f, t) }, 32))
 },
hide: function(a) { var c = this; clearTimeout(this.hideTimer); a = v(a, this.options.hideDelay, 500); this.isHidden || (this.hideTimer = u(function() { c.getLabel()[a ? 'fadeOut':'hide'](); c.isHidden = !0 }, a)) },
...
c = [d.chartX - n.plotLeft, d.chartY - b]); c || (C(a, function(a) { e = a.series.yAxis; r = a.series.xAxis; z += a.plotX + (!m && r ? r.left - q:0); h += (a.plotLow ? (a.plotLow + a.plotHigh) / 2:a.plotY) + (!m && e ? e.top - b:0) }), z /= a.length, h /= a.length, c = [m ? n.plotWidth - h:z, this.shared && !m && a.length>1 && d ? d.chartY - b:m ? n.plotHeight - z:h]); return f(c, Math.round)
},
...
c.plotLeft, c.plotLeft, c.plotLeft + c.plotWidth], r = !this.followPointer && v(f.ttBelow, !c.inverted === !!f.negative), l = function(a, c, k, g, e, d) { var f = k < g - m, w = g + m + k < c, n = g - m - k; g += m; if(r && w)b[a] = g; else if(!r && f)b[a] = n; else if(f)b[a] = Math.min(d - k, n-q<0 ? n:n - q); else if(w)b[a] = Math.max(e, g + q + k > c ? g:g + q); else return!1 }, p = function(a, c, k, g) { var e; g < m || g > c - m ? e = !1:b[a] = g < k / 2 ? 1:g > c - k / 2 ? c - k - 2:g - k / 2; return e }, k = function(a) { var b = h; h = e; e = b; n = a }, w = function() {
 !1 !== l.apply(0, h) ? !1 !== p.apply(0, e) || n || (k(!0), w()):n ? b.x = b.y = 0:(k(!0),
w())
}; (c.inverted || this.len>1) && k(); w(); return b
},
 defaultFormatter: function(a) { var c = this.points || l(this), d; d = [a.tooltipFooterHeaderFormatter(c[0])]; d = d.concat(a.bodyFormatter(c)); d.push(a.tooltipFooterHeaderFormatter(c[0], !0)); return d },
...
"week" !== b && (l = b)
 ...
 tooltipFooterHeaderFormatter: function(a, d) { var c = d ? 'footer':'header'; d = a.series; var f = d.tooltipOptions, m = f.xDateFormat, b = d.xAxis, q = b && 'datetime' === b.options.type && h(a.key), c = f[c + 'Format']; q && !m && (m = this.getXDateFormat(a, f, b)); q && m && (c = c.replace('{point.key}', '{point.key:' + m + '}')); return I(c, {point: a, series: d}) },
...
zoomOption: function(a) { var b = this.chart, m = b.options.chart, d = m.zoomType || '', b = b.inverted; /touch/.test(a.type) && (d = c(m.pinchType, d)); this.zoomX = a = /x/.test(d); this.zoomY = d = /y/.test(d); this.zoomHor = a && !b || d && b; this.zoomVert = d && !b || a && b; this.hasZoom = a || d },
...
a.clientX - c.left), c = a.y):(b = q.pageX - c.left, c = q.pageY - c.top); return l(a, {chartX: Math.round(b), chartY: Math.round(c)})
 ...
 getCoordinates: function(a) { var b = {xAxis: [], yAxis: []}; v(this.chart.axes, function(c) { b[c.isXAxis ? 'xAxis':'yAxis'].push({axis: c, value: c.toValue(a[c.horiz ? 'chartX':'chartY'])}) }); return b },
...
[];} h && (e ? h.noSharedTooltip:h.directTouch) && n ? t = [n]:(e || !h || h.options.stickyTracking || (d = [h]), v(d, function(a) { w = a.noSharedTooltip && e; l = !e && a.directTouch; a.visible && !w && !l && c(a.options.enableMouseTracking, !0) && (u = a.searchPoint(b, !w && a.kdDimensions===1)) && u.series && t.push(u) }), t.sort(function(a, b) { var c = a.distX - b.distX, g = a.dist - b.dist, k = b.series.group.zIndex - a.series.group.zIndex; return c!==0 && e ? c:g!==0 ? g:k!==0 ? k:a.series.index > b.series.index ? -1:1 })); if(e){for(k=t.length;k--;)(t[k].x!==t[0].x||t[k].series.noSharedTooltip)&&
...
(this.unDocMouseMove = D(p, 'mousemove', function(b) { if(G[a.hoverChartIndex])G[a.hoverChartIndex].pointer.onDocumentMouseMove(b) })); v(e ? t:[c(n, t[0])], function(a) { v(m.axes, function(c) { (!a || a.series && a.series[c.coll] === c) && c.drawCrosshair(b, a) }) })
 ...
 reset: function(a, c) {
var b = this.chart, m = b.hoverSeries, e = b.hoverPoint, d = b.hoverPoints, q = b.tooltip, f = q && q.shared ? d:e; a && f && v(y(f), function(b) { b.series.isCartesian && void 0 === b.plotX && (a = !1) }); if(a){q&&f&&(q.refresh(f),e&&(e.setState(e.state,!0),v(b.axes,function(a){a.crosshair&&
a.drawCrosshair(null,e)})));} else{ if(e)e.onMouseOut(); d && v(d, function(a) { a.setState() }); if(m)m.onMouseOut(); q && q.hide(c); this.unDocMouseMove && (this.unDocMouseMove = this.unDocMouseMove()); v(b.axes, function(a) { a.hideCrosshair() }); this.hoverX = this.prevKDPoint = b.hoverPoints = b.hoverPoint = null }
 },
...
(m < n ? m = n:m > n + w && (m = n + w), e < k ? e = k:e > k + h && (e = k + h), this.hasDragged = Math.sqrt(Math.pow(g - m, 2) + Math.pow(p - e, 2)), this.hasDragged>10 && (l = b.isInsidePlot(g - n, p - k), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !u && !t && (this.selectionMarker = t = b.renderer.rect(n, k, d ? 1:w, f ? 1:h, 0).attr({fill: c.selectionMarkerFill || I('#335cad').setOpacity(0.25).get(), 'class': 'highcharts-selection-marker', zIndex: 7}).add()), t && d && (m -= g, t.attr({width: Math.abs(m), x: (m>0 ? 0:m) + g})), t && f && (m = e - p, t.attr({height: Math.abs(m),
y: (m>0 ? 0:m) +
p})), l && !t && c.panning && b.pan(a, c.panning)))
 },
drop: function(a) {
var b = this, c = this.chart, m = this.hasPinched; if(this.selectionMarker) {
 var e = {originalEvent: a, xAxis: [], yAxis: []}, d = this.selectionMarker, n = d.attr ? d.attr('x'):d.x, t = d.attr ? d.attr('y'):d.y, k = d.attr ? d.attr('width'):d.width, w = d.attr ? d.attr('height'):d.height, p; if(this.hasDragged || m){v(c.axes,function(c){if(c.zoomEnabled&&f(c.min)&&(m||b[{xAxis:"zoomX",yAxis:"zoomY"}[c.coll]])){var d=c.horiz,g="touchend"===a.type?c.minPixelPadding:0,q=c.toValue((d?
n:t)+g),d=c.toValue((d?n+k:t+w)-g);e[c.coll].push({axis:c,min:Math.min(q,d),max:Math.max(q,d)});p=!0}}),p&&u(c,"selection",e,function(a){c.zoom(l(a,m?{animation:!1}:null))});} this.selectionMarker = this.selectionMarker.destroy(); m && this.scaleGroups()
}c && (h(c.container, {cursor: c._cursor}), c.cancelClick = this.hasDragged>10, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [])
 },
...
onContainerMouseLeave: function(b) { var c = G[a.hoverChartIndex]; c && (b.relatedTarget || b.toElement) && (c.pointer.reset(), c.pointer.chartPosition = null) },
...
G[a.hoverChartIndex] && G[a.hoverChartIndex].mouseIsDown || (a.hoverChartIndex = c.index); b = this.normalize(b); b.returnValue = !1; 'mousedown' === c.mouseIsDown && this.drag(b); !this.inClass(b.target, 'highcharts-tracker') && !c.isInsidePlot(b.chartX - c.plotLeft, b.chartY - c.plotTop) || c.openMenu || this.runPointActions(b)
 ...
 inClass: function(a, c) { for(var b; a;) { if(b = C(a, 'class')) { if(b.indexOf(c)!==-1)return!0; if(b.indexOf("highcharts-container")!==-1)return!1 }a = a.parentNode } },
...
m, a.chartY - e) && u(b, 'click', a)))
 ...
 setDOMEvents: function() { var b = this, c = b.chart.container; c.onmousedown = function(a) { b.onContainerMouseDown(a) }; c.onmousemove = function(a) { b.onContainerMouseMove(a) }; c.onclick = function(a) { b.onContainerClick(a) }; D(c, 'mouseleave', b.onContainerMouseLeave); a.chartCount===1 && D(p, 'mouseup', b.onDocumentMouseUp); a.hasTouch && (c.ontouchstart = function(a) { b.onContainerTouchStart(a) }, c.ontouchmove = function(a) { b.onContainerTouchMove(a) }, a.chartCount===1 && D(p, 'touchend', b.onDocumentTouchEnd)) },
...
var t = this.chart, m = a ? 'x':'y', b = a ? 'X':'Y', q = 'chart' + b, l = a ? 'width':'height', p = t['plot' + (a ? 'Left':'Top')], e, r, x = y || 1, A = t.inverted, k = t.bounds[a ? 'h':'v'], w = f.length===1, K = f[0][q], J = h[0][q], v = !w && f[1][q], g = !w && h[1][q], B; h = function() { !w && Math.abs(K-v)>20 && (x = y || Math.abs(J - g) / Math.abs(K - v)); r = (p - J) / x + K; e = t['plot' + (a ? 'Width':'Height')] / x }; h(); f = r; f < k.min ? (f = k.min, B = !0):f + e > k.max && (f = k.max - e, B = !0); B ? (J -= 0.8 * (J - n[m][0]), w || (g -= 0.8 * (g - n[m][1])), h()):n[m] = [J,
  g]; A || (c[m] = r - p, c[l] = e); c = A ? 1 / x:x; d[l] = e; d[m] = f; u[A ? a ? 'scaleY':'scaleX':'scale' + b] = x; u['translate' + b] = c * p + (J - c * K)
 },
 pinch: function(a) {
 var p = this, l = p.chart, u = p.pinchDown, d = a.touches, c = d.length, n = p.lastValidTouch, y = p.hasZoom, t = p.selectionMarker, m = {}, b = c===1 && (p.inClass(a.target, 'highcharts-tracker') && l.runTrackerClick || p.runChartClick), q = {}; c>1 && (p.initiated = !0); y && p.initiated && !b && a.preventDefault(); I(d, function(a) { return p.normalize(a) }); 'touchstart' === a.type ? (C(d, function(a, b) {
u[b] = {chartX: a.chartX,
  chartY: a.chartY}
 }), n.x = [u[0].chartX, u[1] && u[1].chartX], n.y = [u[0].chartY, u[1] && u[1].chartY], C(l.axes, function(a) { if(a.zoomEnabled) { var b = l.bounds[a.horiz ? 'h':'v'], c = a.minPixelPadding, m = a.toPixels(f(a.options.min, a.dataMin)), d = a.toPixels(f(a.options.max, a.dataMax)), q = Math.max(m, d); b.min = Math.min(a.pos, Math.min(m, d) - c); b.max = Math.max(a.pos + a.len, q + c) } }), p.res = !0):p.followTouchMove && c===1 ? this.runPointActions(p.normalize(a)):u.length && (t || (p.selectionMarker = t = G({destroy: h, touch: !0}, l.plotBox)), p.pinchTranslate(u,
d, m, t, q, n), p.hasPinched = y, p.scaleGroups(m, q), p.res && (p.res = !1, this.reset(!1, 0)))
},
 touch: function(h, v) {
 var l = this.chart, p, d; if(l.index !== a.hoverChartIndex)this.onContainerMouseLeave({relatedTarget: !0}); a.hoverChartIndex = l.index; h.touches.length===1 ? (h = this.normalize(h), (d = l.isInsidePlot(h.chartX - l.plotLeft, h.chartY - l.plotTop)) && !l.openMenu ? (v && this.runPointActions(h), 'touchmove' === h.type && (v = this.pinchDown, p = v[0] ? Math.sqrt(Math.pow(v[0].chartX-h.chartX,2)+Math.pow(v[0].chartY-h.chartY,2))>=4:!1), f(p,
!0) && this.pinch(h)):v && this.reset()):h.touches.length===2 && this.pinch(h)
 },
...
d[a.pointerId] = {pageX: a.pageX,
 pageY: a.pageY,
  target: a.currentTarget}
})
},
 onContainerPointerMove: function(a) { y(a, 'onContainerTouchMove', 'touchmove', function(a) { d[a.pointerId] = {pageX: a.pageX, pageY: a.pageY}; d[a.pointerId].target || (d[a.pointerId].target = a.currentTarget) }) },
...
var D, C = a.addEvent, G = a.css, I = a.discardElement, h = a.defined, f = a.each, p = a.extend, v = a.isFirefox, l = a.marginNames,
  u = a.merge, d = a.pick, c = a.setAnimation, n = a.stableSort, y = a.win, t = a.wrap; D = a.Legend = function(a, b) { this.init(a, b) }; D.prototype = {init: function(a, b) { this.chart = a; this.setOptions(b); b.enabled && (this.render(), C(this.chart, 'endResize', function() { this.legend.positionCheckboxes() })) },
...
b - 5; this.itemHeight = this.maxItemWidth = 0; this.symbolWidth = d(a.symbolWidth, 16); this.pages = []
 ...
 update: function(a, b) { var c = this.chart; this.setOptions(u(!0, this.options, a)); this.destroy(); c.isDirtyLegend = c.isDirtyBox = !0; d(b, !0) && c.redraw() },
colorizeItem: function(a, b) {
 ...
 positionItem: function(a) { var b = this.options, c = b.symbolPadding, b = !b.rtl, d = a._legendItemPos, m = d[0], d = d[1], e = a.checkbox; (a = a.legendGroup) && a.element && a.translate(b ? m:this.legendWidth - m - 2 * c - 4, d); e && (e.x = m, e.y = d) },
destroyItem: function(a) { var b = a.checkbox; f(['legendItem', 'legendLine', 'legendSymbol', 'legendGroup'], function(b) { a[b] && (a[b] = a[b].destroy()) }); b && I(a.checkbox) },
  destroy: function() { function a(a) { this[a] && (this[a] = this[a].destroy()) }f(this.getAllItems(), function(b) { f(['legendItem', 'legendGroup'], a, b) }); f(['box', 'title', 'group'], a, this); this.display = null },
 positionCheckboxes: function(a) { var b = this.group && this.group.alignAttr, c, d = this.clipHeight || this.legendHeight, m = this.titleHeight; b && (c = b.translateY, f(this.allItems, function(e) { var f = e.checkbox, h; f && (h = c + m + f.y + (a || 0) + 3, G(f, {left: b.translateX + e.checkboxOffset + f.x - 20 + 'px', top: h + 'px', display: h > c - 6 && h < c + d - 6 ? '':'none'})) })) },
  renderTitle: function() { var a = this.padding, b = this.options.title, c = 0; b.text && (this.title || (this.title = this.chart.renderer.label(b.text, a - 3, a - 4, null, null, null, null, null, 'legend-title').attr({zIndex: 1}).css(b.style).add(this.group)), a = this.title.getBBox(), c = a.height, this.offsetWidth = a.width, this.contentGroup.attr({translateY: c})); this.titleHeight = c },
setText: function(c) { var b = this.options; c.legendItem.attr({text: b.labelFormat ? a.format(b.labelFormat, c):b.labelFormatter.call(c)}) },
...
getAllItems: function() { var a = []; f(this.chart.series, function(b) { var c = b && b.options; b && d(c.showInLegend, h(c.linkedTo) ? !1:void 0, !0) && (a = a.concat(b.legendItems || ('point' === c.legendType ? b.data:b))) }); return a },
...
h = a.getAllItems(); n(h, function(a, b) { return(a.options && a.options.legendIndex || 0) - (b.options && b.options.legendIndex || 0) }); k.reversed && h.reverse(); a.allItems = h; a.display = e = !!h.length; a.lastLineHeight = 0; f(h, function(b) { a.renderItem(b) }); r = (k.width || a.offsetWidth) + w; l = a.lastItemY + a.lastLineHeight + a.titleHeight; l = a.handleOverflow(l); l += w; t || (a.box = t = c.rect().addClass('highcharts-legend-box').attr({r: k.borderRadius}).add(d), t.isNew = !0); t.attr({stroke: k.borderColor,
'stroke-width': k.borderWidth || 0,
fill: k.backgroundColor ||
'none'}).shadow(k.shadow); r>0 && l>0 && (t[t.isNew ? 'attr':'animate'](t.crisp({x: 0, y: 0, width: r, height: l}, t.strokeWidth())), t.isNew = !1); t[e ? 'show':'hide'](); a.legendWidth = r; a.legendHeight = l; f(h, function(b) { a.positionItem(b) }); e && d.align(p({width: r, height: l}, k), !0, 'spacingBox'); b.isResizing || this.positionCheckboxes()
 },
handleOverflow: function(a) {
...
scroll: function(a, b) {
var d = this.pages, f = d.length; a = this.currentPage + a; var m = this.clipHeight, e = this.options.navigation, h = this.pager, n = this.padding; a > f && (a = f); a>0 && (void 0 !== b && c(b, this.chart), this.nav.attr({translateX: n, translateY: m + this.padding + 7 + this.titleHeight, visibility: 'visible'}), this.up.attr({'class': a===
1 ? 'highcharts-legend-nav-inactive':'highcharts-legend-nav-active'}), h.attr({text: a + '/' + f}), this.down.attr({x: 18 + this.pager.getBBox().width, 'class': a === f ? 'highcharts-legend-nav-inactive':'highcharts-legend-nav-active'}), this.up.attr({fill: a===1 ? e.inactiveColor:e.activeColor}).css({cursor: a===1 ? 'default':'pointer'}), this.down.attr({fill: a === f ? e.inactiveColor:e.activeColor}).css({cursor: a === f ? 'default':'pointer'}), b = -d[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: b}), this.currentPage =
a, this.positionCheckboxes(b))
}}; a.LegendSymbolMixin = {drawRectangle: function(a, b) { var c = a.options, f = c.symbolHeight || a.fontMetrics.f, c = c.squareSymbol; b.legendSymbol = this.chart.renderer.rect(c ? (a.symbolWidth - f) / 2:0, a.baseline - f + 1, c ? f:a.symbolWidth, f, d(a.options.symbolRadius, f / 2)).addClass('highcharts-point').attr({zIndex: 3}).add(b.legendGroup) },
drawLineMarker: function(a) {
 var b = this.options, c = b.marker, d = a.symbolWidth, f = this.chart.renderer, e = this.legendGroup; a = a.baseline - Math.round(0.3 * a.fontMetrics.b)
var m; m = {'stroke-width': b.lineWidth || 0}; b.dashStyle && (m.dashstyle = b.dashStyle); this.legendLine = f.path(['M', 0, a, 'L', d, a]).addClass('highcharts-graph').attr(m).add(e); c && !1 !== c.enabled && (b = this.symbol.indexOf("url")===0 ? 0:c.radius, this.legendSymbol = c = f.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b, c).addClass('highcharts-point').add(e), c.isMarker = !0)
...
b, c) { return new E(a, b, c) }; E.prototype = {callbacks: [],
getArgs: function() { var a = [].slice.call(arguments); if(e(a[0]) || a[0].nodeName)this.renderTo = a.shift(); this.init(a[0], a[1]) },
 init: function(b, c) {
...
u.push(this); a.chartCount++; if(g)for(e in g)D(this, e, g[e]); this.xAxis = []; this.yAxis = []; this.pointCount = this.colorCounter = this.symbolCounter = 0; this.firstRender()
 ...
 initSeries: function(b) { var c = this.options.chart; (c = N[b.type || c.type || c.defaultSeriesType]) || a.error(17, !0); c = new c(); c.init(this, b); return c },
isInsidePlot: function(a, b, c) { var k = c ? b:a; a = c ? a:b; return k>=0 && k <= this.plotWidth && a>=0 && a <= this.plotHeight },
redraw: function(b) {
...
a || b.options.id === a
 ...
 getAxes: function() { var a = this, b = this.options, c = b.xAxis = g(b.xAxis || {}), b = b.yAxis = g(b.yAxis || {}); n(c, function(a, b) { a.index = b; a.isX = !0 }); n(b, function(a, b) { a.index = b }); c = c.concat(b); n(c, function(b) { new f(a, b) }) },
 getSelectedPoints: function() { var a = []; n(this.series, function(b) { a = a.concat(q(b.points || [], function(a) { return a.selected })) }); return a },
...
w(a, !0) && this.isDirtyBox && this.redraw())
 ...
 getChartSize: function() { var a = this.options.chart, k = a.width, a = a.height, g = this.renderToClone || this.renderTo; c(k) || (this.containerWidth = b(g, 'width')); c(a) || (this.containerHeight = b(g, 'height')); this.chartWidth = Math.max(0, k || this.containerWidth || 600); this.chartHeight = Math.max(0, w(a, this.containerHeight>19 ? this.containerHeight:400)) },
...
b); this.extraBottomMargin && (this.marginBottom += this.extraBottomMargin); this.extraTopMargin && (this.plotTop += this.extraTopMargin); a || this.getAxisMargins()
 ...
 getAxisMargins: function() { var a = this, b = a.axisOffset = [0, 0, 0, 0], k = a.margin; a.hasCartesianSeries && n(a.axes, function(a) { a.visible && a.getOffset() }); n(x, function(g, e) { c(k[e]) || (a[g] += b[e]) }); a.setChartSize() },
reflow: function(a) {
...
!k.isPrinting && f && g && (e === M || e === h)) { if(f !== k.containerWidth || g !== k.containerHeight)clearTimeout(k.reflowTimeout), k.reflowTimeout = S(function() { k.container && k.setSize(void 0, void 0, !1) }, a ? 100:0); k.containerWidth = f; k.containerHeight = g }
 ...
 initReflow: function() { var a = this, b; b = D(M, 'resize', function(b) { a.reflow(b) }); D(a, 'destroy', b) },
...
linkSeries: function() { var a = this, b = a.series; n(b, function(a) { a.linkedSeries.length = 0 }); n(b, function(b) { var c = b.options.linkedTo; e(c) && (c = ':previous' === c ? a.series[b.index - 1]:a.get(c)) && c.linkedParent !== b && (c.linkedSeries.push(b), b.linkedParent = c, b.visible = w(b.options.visible, c.options.visible, b.visible)) }) },
...
a.render()
 ...
 renderLabels: function() { var a = this, b = a.options.labels; b.items && n(b.items, function(c) { var g = y(b.style, c.style), k = K(g.left) + a.plotLeft, e = K(g.top) + a.plotTop + 12; delete g.left; delete g.top; a.renderer.text(c.html, k, e).attr({zIndex: 2}).css(g).add() }) },
 render: function() {
...
this.getAxisMargins(); k = c/this.plotWidth>1.1; e = g/this.plotHeight>1.05; if(k || e)n(a, function(a) { (a.horiz && k || !a.horiz && e) && a.setTickInterval(!0) }), this.getMargins(); this.drawChartBox(); this.hasCartesianSeries && n(a, function(a) { a.visible && a.render() }); this.seriesGroup || (this.seriesGroup = b.g('series-group').attr({zIndex: 3}).add()); this.renderSeries(); this.renderLabels(); this.addCredits(); this.setResponsive && this.setResponsive(); this.hasRendered = !0
 },
...
!this.isValid(), this.x===null || !v(this.y, !0)); this.selected && (this.state = 'select'); 'name' in this && void 0 === c && d.xAxis && d.xAxis.hasNames && (this.x = d.xAxis.nameToX(this)); void 0 === this.x && d && (this.x = void 0 === c ? d.autoIncrement(this):c); return this
 },
 optionsToObject: function(a) {
var c = {}, d = this.series, f = d.options.keys, h = f || d.pointArrayMap || ['y'], m = h.length, b = 0, l = 0; if(v(a) || a===null)c[h[0]] = a; else if(p(a)){for(!f&&a.length>m&&(d=typeof a[0],"string"===d?c.name=a[0]:"number"===d&&(c.x=a[0]),b++);l<m;)f&&void 0===
...
getClassName: function() { return'highcharts-point' + (this.selected ? ' highcharts-point-select':'') + (this.negative ? ' highcharts-negative':'') + (this.isNull ? ' highcharts-null-point':'') + (void 0 !== this.colorIndex ? ' highcharts-color-' + this.colorIndex:'') + (this.options.className ? ' ' + this.options.className:'') + (this.zone && this.zone.className ? ' ' + this.zone.className:'') },
  getZone: function() { var a = this.series, c = a.zones, a = a.zoneAxis || 'y', f = 0, h; for(h = c[f]; this[a] >= h.value;)h = c[++f]; h && h.color && !this.options.color && (this.color = h.color); return h },
 destroy: function() { var a = this.series.chart, c = a.hoverPoints, f; a.pointCount--; c && (this.setState(), I(c, this), c.length || (a.hoverPoints = null)); if(this === a.hoverPoint)this.onMouseOut(); if(this.graphic || this.dataLabel)u(this), this.destroyElements(); this.legendItem && a.legend.destroyItem(this); for(f in this)this[f] = null },
...
if(t || m)a = a.replace(b + '}', t + b + '}' + m); a = a.replace(b + '}', b + ':,.' + h + 'f}')
 ...
 firePointEvent: function(a, c, f) { var d = this, n = this.series.options; (n.point.events[a] || d.options && d.options.events && d.options.events[a]) && this.importEvents(); 'click' === a && n.allowPointSelect && (f = function(a) { d.select && d.select(null, a.ctrlKey || a.metaKey || a.shiftKey) }); h(this, a, c, f) },
visible: !0}
})(L); (function(a) {
var D = a.addEvent, C = a.animObject, G = a.arrayMax, I = a.arrayMin, h = a.correctFloat,
  f = a.Date, p = a.defaultOptions, v = a.defaultPlotOptions, l = a.defined, u = a.each, d = a.erase, c = a.extend, n = a.fireEvent, y = a.grep, t = a.isArray, m = a.isNumber, b = a.isString, q = a.merge, z = a.pick, F = a.removeEvent, e = a.splat, r = a.SVGElement, x = a.syncTimeout, A = a.win; a.Series = a.seriesType('line', null, {lineWidth: 2,
 allowPointSelect: !1,
showCheckbox: !1,
animation: {duration: 1E3},
 ...
 lineColor: '#ffffff',
 radius: 4,
 states: {hover: {animation: {duration: 50}, enabled: !0, radiusPlus: 2, lineWidthPlus: 1},
...
!1); k.isCartesian && (a.hasCartesianSeries = !0); g.length && (f = g[g.length - 1]); k._i = z(f && f._i, -1) + 1; for(a = this.insert(g); a < g.length; a++)g[a].index = a, g[a].name = g[a].name || 'Series ' + (g[a].index + 1)
 ...
 insert: function(a) { var b = this.options.index, c; if(m(b)) { for(c = a.length; c--;)if(b >= z(a[c].options.index, a[c]._i)) { a.splice(c + 1, 0, this); break }c===-1 && a.unshift(this); c += 1 }else a.push(this); return z(c, a.length - 1) },
 bindAxes: function() {
var b = this, c = b.options, e = b.chart, d; u(b.axisTypes || [], function(k) {
 u(e[k], function(a) {
 d =
a.options; if(c[k] === d.index || void 0 !== c[k] && c[k] === d.id || void 0 === c[k] && d.index===0)b.insert(a.series), b[k] = a, a.isDirty = !0
}); b[k] || b.optionalAxis === k || a.error(18, !0)
})
},
 updateParallelArrays: function(a, b) { var c = a.series, k = arguments, e = m(b) ? function(g) { var k = 'y' === g && c.toYData ? c.toYData(a):a[g]; c[g + 'Data'][b] = k }:function(a) { Array.prototype[b].apply(c[a + 'Data'], Array.prototype.slice.call(k, 2)) }; u(c.parallelArrays, e) },
...
b.tooltip, k.series && k.series.tooltip, k[this.type] && k[this.type].tooltip, a.tooltip); e.marker===null && delete c.marker; this.zoneAxis = c.zoneAxis; a = this.zones = (c.zones || []).slice(); !c.negativeColor && !c.negativeFillColor || c.zones || a.push({value: c[this.zoneAxis + 'Threshold'] || c.threshold || 0, className: 'highcharts-negative', color: c.negativeColor, fillColor: c.negativeFillColor}); a.length && l(a[a.length - 1].value) && a.push({color: this.color, fillColor: this.fillColor}); return c
 },
...
var k = this, g = k.points, h = g && g.length || 0, n, r = k.options, w = k.chart, l = null, q = k.xAxis, p = r.turboThreshold, x = this.xData, A = this.yData, F = (n = k.pointArrayMap) && n.length; c = c || []; n = c.length; e = z(e, !0); if(!1 !== f && n && h === n && !k.cropped && !k.hasGroupedData && k.visible)u(c, function(a, b) { g[b].update && a !== r.data[b] && g[b].update(a, !1, null, !1) }); else{
 ...
 for(d = 0; l===null && d < n;)l = c[d], d++; if(m(l)){for(d=
...
l[h]);else k[g++]=l;} this.dataMin = I(k); this.dataMax = G(k)
 ...
 translate: function() {
 this.processedXData || this.processData(); this.generatePoints(); var a = this.options, b = a.stacking, c = this.xAxis, e = c.categories, d = this.yAxis, g = this.points, f = g.length, n = !!this.modifyValue, r = a.pointPlacement, t = 'between' === r || m(r), q = a.threshold, p = a.startFromThreshold ? q:0, x, u, A, F, v = Number.MAX_VALUE; 'between' === r && (r = 0.5); m(r) && (r *= z(a.pointRange || c.pointRange)); for(a = 0; a < f; a++) {
var y = g[a], C = y.x, D = y.y; u = y.low; var G = b && d.stacks[(this.negStacks &&
D < (p ? 0:q) ? '-':'') + this.stackKey], I; d.isLog && D!==null && D<=0 && (y.isNull = !0); y.plotX = x = h(Math.min(Math.max(-1E5, c.translate(C, 0, 0, 0, 1, r, 'flags' === this.type)), 1E5)); b && this.visible && !y.isNull && G && G[C] && (F = this.getStackIndicator(F, C, this.index), I = G[C], D = I.points[F.key], u = D[0], D = D[1], u === p && F.key === G[C].base && (u = z(q, d.min)), d.isLog && u<=0 && (u = null), y.total = y.stackTotal = I.total, y.percentage = I.total && y.y / I.total * 100, y.stackY = D, I.setOffset(this.pointXOffset || 0, this.barW || 0)); y.yBottom = l(u) ? d.translate(u, 0,
1, 0, 1):null; n && (D = this.modifyValue(D, y)); y.plotY = u = 'number' === typeof D && Infinity !== D ? Math.min(Math.max(-1E5, d.translate(D, 0, 1, 0, 1)), 1E5):void 0; y.isInside = void 0 !== u && u>=0 && u <= d.len && x>=0 && x <= c.len; y.clientX = t ? h(c.translate(C, 0, 0, 0, 1, r)):x; y.negative = y.y < (q || 0); y.category = e && void 0 !== e[y.x] ? e[y.x]:y.x; y.isNull || (void 0 !== A && (v = Math.min(v, Math.abs(x - A))), A = x); y.zone = this.zones.length && y.getZone()
...
1); !1 !== c.clip && (this.group.clip(a || g ? h:b.clipRect), this.markerGroup.clip(m), this.sharedClipKey = f); a || (h.count[this.index] && (delete h.count[this.index], --h.count.length), h.count.length===0 && f && b[f] && (g || (b[f] = b[f].destroy()), b[f + 'm'] && (b[f + 'm'] = b[f + 'm'].destroy())))
 },
animate: function(a) { var b = this.chart, c = C(this.options.animation), e; a ? this.setClip(c):(e = this.sharedClipKey, (a = b[e]) && a.animate({width: b.plotSizeX}, c), b[e + 'm'] && b[e + 'm'].animate({width: b.plotSizeX + 99}, c), this.animate = null) },
...
e,
y: a.plotY - e}; e && (a.width = a.height = 2 * e); return a
},
pointAttribs: function(a, b) {
var c = this.options.marker, e = a && a.options, k = e && e.marker || {}, g = this.color, d = e && e.color, f = a && a.color, e = z(k.lineWidth, c.lineWidth); a = a && a.zone && a.zone.color; g = d || a || f || g; a = k.fillColor || c.fillColor || g; g = k.lineColor || c.lineColor || g; b && (c = c.states[b], b = k.states && k.states[b] || {}, e = z(b.lineWidth, c.lineWidth, e + z(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g); return{stroke: g,
 'stroke-width': e,
  fill: a}
},
 destroy: function() {
...
var r = d.plotX, t = d.plotY, q = a[n - 1]; (d.leftCliff || q && q.rightCliff) && !c && (m = !0); d.isNull && !l(b) && n>0 ? m = !k.connectNulls:d.isNull && !b ? m = !0:(n===0 || m ? n = ['M', d.plotX, d.plotY]:e.getPointSpline ? n = e.getPointSpline(a, d, n):g ? (n = g===1 ? ['L', q.plotX,
  t]:g===2 ? ['L', (q.plotX + r) / 2, q.plotY, 'L', (q.plotX + r) / 2, t]:['L', r, q.plotY], n.push('L', r, t)):n = ['L', r, t], h.push(d.x), g && h.push(d.x), f.push.apply(f, n), m = !1)
...
d = t ? x ? b.plotWidth:0:x ? 0:l.toPixels(q.min); d = Math.min(Math.max(z(g, d), 0), r); g = Math.min(Math.max(Math.round(l.toPixels(z(e.value, q.max), !0)), 0), r); v && (d = g = l.toPixels(q.max)); A = Math.abs(d - g); F = Math.min(d, g); y = Math.max(d, g); l.isXAxis ? (h = {x: p ? y:F,
 y: 0,
width: A,
...
c[e].attr(b).invert(a)
 ...
 plotGroup: function(a, b, c, e, d) { var g = this[a], k = !g; k && (this[a] = g = this.chart.renderer.g(b).attr({zIndex: e || 0.1}).add(d), g.addClass('highcharts-series-' + this.index + ' highcharts-' + this.type + '-series highcharts-color-' + this.colorIndex + ' ' + (this.options.className || ''))); g.attr({visibility: c})[k ? 'attr':'animate'](this.getPlotBox()); return g },
 getPlotBox: function() {
...
e.left, a.plotLeft),
 translateY: z(d && d.top, a.plotTop)})); this.translate(); this.render(); b && delete this.kdTree
},
kdDimensions: 1,
 kdAxisArray: ['clientX', 'plotY'],
 searchPoint: function(a, b) { var c = this.xAxis, e = this.yAxis, d = this.chart.inverted; return this.searchKDTree({clientX: d ? c.len - a.chartY + c.pos:a.chartX - c.pos, plotY: d ? e.len - a.chartX + e.pos:a.chartY - e.pos}, b) },
...
n<0 ? 'left':'right'; q = n<0 ? 'right':'left'; b[r] && (r = c(a, b[r], f + 1, h), t = r[k] < t[k] ? r:m); b[q] && Math.sqrt(n * n) < t[k] && (a = c(a, b[q], f + 1, h), t = a[k] < t[k] ? a:t); return t
...
this.leftCliff = 0; this.alignOptions = {align: d.align || (n ? c ? 'left':'right':'center'), verticalAlign: d.verticalAlign || (n ? 'middle':c ? 'bottom':'top'), y: l(d.y, n ? 4:c ? 14:-6), x: l(d.x, n ? c ? -6:6:0)}; this.textAlign = d.textAlign || (n ? c ? 'right':'left':'center')
 }var C = a.Axis, G = a.Chart, I = a.correctFloat, h = a.defined, f = a.destroyObjectProperties, p = a.each, v = a.format, l = a.pick; a = a.Series; D.prototype = {destroy: function() { f(this, this.axis) },
render: function(a) {
...
setOffset: function(a, d) {
 var c = this.axis, f = c.chart, h = f.inverted, l = c.reversed, l = this.isNegative && !l || !this.isNegative && l, m = c.translate(c.usePercentage ? 100:this.total, 0, 0, 0, 1), c = c.translate(0), c = Math.abs(m - c); a = f.xAxis[0].translate(this.x) + a; var b = f.plotHeight, h = {x: h ? l ? m:m - c:a,
y: h ? b - a - d:l ? b - m - c:b - m,
width: h ?
c:d,
 height: h ? d:c}; if(d = this.label)d.align(this.alignOptions, null, h), h = d.alignAttr, d[!1 === this.options.crop || f.isInsidePlot(h.x, h.y) ? 'show':'hide'](!0)
...
function() { var a = this, d = a.stackKey, c = a.yAxis.stacks, f = a.processedXData, h; p([d, '-' + d], function(d) { for(var m = f.length, b, n; m--;)if(b = f[m], h = a.getStackIndicator(h, b, a.index, d), b = (n = c[d] && c[d][b]) && n.points[h.key])n = n.total ? 100 / n.total:0, b[0] = I(b[0] * n), b[1] = I(b[1] * n), a.stackedYData[m] = b[1] }) }; a.prototype.getStackIndicator = function(a, d, c, f) { !h(a) || a.x !== d || f && a.key !== f ? a = {x: d, index: 0, key: f}:a.index++; a.key = [c, d, a.index].join(); return a }
 ...
 var D = a.addEvent, C = a.animate, G = a.Axis, I = a.createElement,
  h = a.css, f = a.defined, p = a.each, v = a.erase, l = a.extend, u = a.fireEvent, d = a.inArray, c = a.isNumber, n = a.isObject, y = a.merge, t = a.pick, m = a.Point, b = a.Series, q = a.seriesTypes, z = a.setAnimation, F = a.splat; l(a.Chart.prototype, {addSeries: function(a, b, c) { var e, d = this; a && (b = t(b, !0), u(d, 'addSeries', {options: a}, function() { e = d.initSeries(a); d.isDirtyLegend = !0; d.linkSeries(); b && d.redraw(c) })); return e },
...
{zIndex: 10})); h(b.loadingSpan, d.labelStyle); b.loadingShown || (h(e, {opacity: 0, display: ''}), C(e, {opacity: d.style.opacity || 0.5}, {duration: d.showDuration || 0})); b.loadingShown = !0; f()
},
hideLoading: function() { var a = this.options, b = this.loadingDiv; b && (b.className = 'highcharts-loading highcharts-loading-hidden', C(b, {opacity: 0}, {duration: a.loading.hideDuration || 100, complete: function() { h(b, {display: 'none'}) }})); this.loadingShown = !1 },
...
}for(e in a) { if(this[e] && 'function' === typeof this[e].update)this[e].update(a[e], !1); else if('function' === typeof this[h[e]])this[h[e]](a[e]); 'chart' !== e && d(e,this.propsRequireUpdateSeries)!==-1 && (n = !0) }a.colors && (this.options.colors = a.colors); a.plotOptions && y(!0, this.options.plotOptions, a.plotOptions); p(['xAxis', 'yAxis', 'series'], function(b) { a[b] && p(F(a[b]), function(a) { var c = f(a.id) && this.get(a.id) || this[b][0]; c && c.coll === b && c.update(a, !1) }, this) }, this)
m && p(this.axes, function(a) { a.update({}, !1) }); n && p(this.series, function(a) { a.update({}, !1) }); a.loading && y(!0, this.options.loading, a.loading); e = k && k.width; k = k && k.height; c(e) && e !== this.chartWidth || c(k) && k !== this.chartHeight ? this.setSize(e, k):t(b, !0) && this.redraw()
 ...
 setSubtitle: function(a) { this.setTitle(void 0, a) }}); l(m.prototype, {update: function(a, b, c, d) {
function e() {
 f.applyOptions(a); f.y===null && m && (f.graphic = m.destroy()); n(a, !0) && (m && m.element && a && a.marker && a.marker.symbol && (f.graphic = m.destroy()),
...
remove: function(a, b) { this.series.removePoint(d(this, this.series.data), a, b) }}); l(b.prototype, {addPoint: function(a,
b, c, d) {
...
void 0;} l(this, q[h || f].prototype); p(n, function(a) { c[a] = n[a] }); this.init(e, a); e.linkSeries(); t(b, !0) && e.redraw(!1)
 }}); l(G.prototype, {update: function(a, b) { var c = this.chart; a = c.options[this.coll][this.options.index] = y(this.userOptions, a); this.destroy(!0); this.init(c, l(a, {events: void 0})); c.isDirtyBox = !0; t(b, !0) && c.redraw() },
 remove: function(a) {
...
var D = a.color, C = a.each, G = a.map, I = a.pick, h = a.Series, f = a.seriesType; f('area', 'line', {softThreshold: !1, threshold: 0}, {singleStacks: !1,
...
!0) ? 1:-1, z, F; if(this.options.stacking) {
 for(z = 0; z < n.length; z++)c[n[z].x] = n[z]; for(F in d)d[F].total!==null && f.push(F); f.sort(function(a, b) { return a - b }); b = G(t, function() { return this.visible }); C(f, function(e, n) {
 var l = 0, r, k; if(c[e] && !c[e].isNull)a.push(c[e]), C([-1, 1], function(a) { var h = a===1 ? 'rightNull':'leftNull', l = 0, t = d[f[n + a]]; if(t)for(z = y; z>=0 && z < m;)r = t.points[z], r || (z === y ? c[e][h] = !0:b[z] && (k = d[e].points[z]) && (l -= k[1] - k[0])), z += q; c[e][a===1 ? 'rightCliff':'leftCliff'] = l }); else{
 for(z = y; z>=0 && z < m;) {
if(r =
...
a[e] && a[e].isNull && (n = l = z); void 0 !== n && (t.push({plotX: b, plotY: n===null ? F:d.getThreshold(n), isNull: k}), y.push({plotX: b, plotY: l===null ? F:d.getThreshold(l), doCurve: !1}))
...
zIndex: 0}).add(a.group), h.isArea = !0); h.startX = f.xMap; h.shiftUnit = l.step ? 2:1
})
 },
...
u !== v && (c = (d - l) * (u - h) / (u - v) + f - d); l += c; d += c; l > a && l > f ? (l = Math.max(a, f), d = 2 * f - l):l < a && l < f && (l = Math.min(a, f), d = 2 * f - l); d > I && d > f ? (d = Math.max(I, f), l = 2 * f - d):d < I && d < f && (d = Math.min(I, f), l = 2 * f - d); G.rightContX = u; G.rightContY = d
 ...
 var D = a.seriesTypes.area.prototype, C = a.seriesType; C('areaspline', 'spline', a.defaultPlotOptions.area, {getStackPoints: D.getStackPoints,
 getGraphPath: D.getGraphPath,
  setStackCliffs: D.setStackCliffs,
 drawGraph: D.drawGraph,
drawLegendSymbol: a.LegendSymbolMixin.drawRectangle})
})(L); (function(a) {
 var D = a.animObject, C = a.color, G = a.each, I = a.extend, h = a.isNumber, f = a.merge, p = a.pick, v = a.Series, l = a.seriesType, u = a.svg; l('column', 'line', {borderRadius: 0,
 groupPadding: 0.2,
 marker: null,
 pointPadding: 0.1,
minPointLength: 0,
...
trackerGroups: ['group', 'dataLabelsGroup'],
 negStacks: !0,
init: function() { v.prototype.init.apply(this, arguments); var a = this, c = a.chart; c.hasRendered && G(c.series, function(c) { c.type === a.type && (c.isDirty = !0) }) },
...
c.options, d = c.yAxis, f; c.type === a.type && c.visible && h.len === d.len && h.pos === d.pos && (e.stacking ? (m = c.stackKey, void 0 === b[m] && (b[m] = q++), f = b[m]):!1 !== e.grouping && (f = q++), c.columnIndex = f)
  ...
  crispCol: function(a, c, f, h) { var d = this.chart, m = this.borderWidth, b = -(m % 2 ? 0.5:0), m = m % 2 ? 0.5:1; d.inverted && d.renderer.isVML && (m += 1); f = Math.round(a + f) + b; a = Math.round(a) + b; h = Math.round(c + h) + m; b = 0Math.abs(c)<=.5 && 0h>.5; c = Math.round(c) + m; h -= c; b && h && (--c, h += 1); return{x: a, y: c, width: f - a, height: h} },
 translate: function() {
var a = this, c = a.chart, f = a.options, h = a.dense = a.closestPointRange*a.xAxis.transA<2, h = a.borderWidth = p(f.borderWidth, h ? 0:1), l = a.yAxis, m = a.translatedThreshold = l.getThreshold(f.threshold), b = p(f.minPointLength,
5), q = a.getColumnMetrics(), u = q.width, F = a.barW = Math.max(u, 1 + 2 * h), e = a.pointXOffset = q.offset; c.inverted && (m -= 0.5); f.pointPadding && (F = Math.ceil(F)); v.prototype.translate.apply(a); G(a.points, function(d) {
...
b.y!==null) { m = b.shapeArgs; if(d)d[c.pointCount < t ? 'animate':'attr'](f(m)); else b.graphic = d = p[b.shapeType](m).attr({'class': b.getClassName()}).add(b.group || a.group); d.attr(a.pointAttribs(b, b.selected && 'select')).shadow(l.shadow, null, l.stacking && !l.borderRadius) }else d && (b.graphic = d.destroy())
 })
 },
animate: function(a) {
var c = this, d = this.yAxis, f = c.options, h = this.chart.inverted, m = {}; u && (a ? (m.scaleY = 0.001, a = Math.min(d.pos + d.len, Math.max(d.pos, d.toPixels(f.threshold))), h ? m.translateX = a - d.len:m.translateY = a, c.group.attr(m))
:(m[h ? 'translateX':'translateY'] = d.pos, c.group.animate(m, I(D(c.options.animation), {step: function(a, d) { c.group.attr({scaleY: Math.max(0.001, d.pos)}) }})), c.animate = null))
 },
...
var D = a.Series; a = a.seriesType; a('scatter', 'line', {lineWidth: 0,
 ...
 tooltip: {headerFormat: '\x3cspan style\x3d"color:{point.color}"\x3e\u25cf\x3c/span\x3e \x3cspan style\x3d"font-size: 0.85em"\x3e {series.name}\x3c/span\x3e\x3cbr/\x3e',
  pointFormat: 'x: \x3cb\x3e{point.x}\x3c/b\x3e\x3cbr/\x3ey: \x3cb\x3e{point.y}\x3c/b\x3e\x3cbr/\x3e'}}, {sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ['group', 'markerGroup', 'dataLabelsGroup'], takeOrdinalPosition: !1, kdDimensions: 2, drawGraph: function() { this.options.lineWidth && D.prototype.drawGraph.call(this) }})
 })(L); (function(a) {
...
2 * h, p = a.center, p = [D(p[0], '50%'), D(p[1], '50%'), a.size || '100%', a.innerSize || 0], v = Math.min(f, I), l, u; for(l = 0; l<4; ++l)u = p[l], a = l<2 || l===2 && /%$/.test(u), p[l] = C(u, [f, I, v, p[2]][l]) + (a ? h:0); p[3] > p[2] && (p[3] = p[2]); return p
 }}
 })(L); (function(a) {
var D = a.addEvent, C = a.defined, G = a.each, I = a.extend, h = a.inArray, f = a.noop, p = a.pick, v = a.Point, l = a.Series, u = a.seriesType, d = a.setAnimation; u('pie', 'line', {center: [null, null],
 clip: !1,
colorByPoint: !0,
...
updateTotals: function() { var a, d = 0, f = this.points, h = f.length, m, b = this.options.ignoreHiddenPoint; for(a = 0; a < h; a++)m = f[a], m.y<0 && (m.y = null), d += b && !m.visible ? 0:m.y; this.total = d; for(a = 0; a < h; a++)m = f[a], m.percentage = d>0 && (m.visible || !b) ? m.y / d * 100:0, m.total = d },
 generatePoints: function() { l.prototype.generatePoints.call(this); this.updateTotals() },
...
h, a[0] + b, a[1] + l, x<0 ? 'center':w.half ? 'right':'left', u]
 }
},
 drawGraph: null,
drawPoints: function() {
...
setVisible: function(a, d) { var c = this, f = c.series, m = f.chart, b = f.options.ignoreHiddenPoint; d = p(d, b); a !== c.visible && (c.visible = c.options.visible = a = void 0 === a ? !c.visible:a, f.options.data[h(c, f.data)] = c.options, G(['graphic', 'dataLabel', 'connector', 'shadowGroup'], function(b) { if(c[b])c[b][a ? 'show':'hide'](!0) }), c.legendItem && m.legend.colorizeItem(c, a), a || 'hover' !== c.state || c.setState(''), b && (f.isDirty = !0), d && m.redraw()) },
  slice: function(a, f, l) { var c = this.series; d(l, c.chart); p(f, !0); this.sliced = this.options.sliced = a = C(a) ? a:!this.sliced; c.options.data[h(this, c.data)] = this.options; a = a ? this.slicedTranslation:{translateX: 0, translateY: 0}; this.graphic.animate(a); this.shadowGroup && this.shadowGroup.animate(a) },
...
for(d = a.length; d--;){f=
a[d],m=(Math.min.apply(0,f.targets)+Math.max.apply(0,f.targets))/2,f.pos=Math.min(Math.max(0,m-f.size/2),c-f.size);} d = a.length; for(f = !1; d--;)d>0 && a[d - 1].pos + a[d - 1].size > a[d].pos && (a[d - 1].size += a[d].size, a[d - 1].targets = a[d - 1].targets.concat(a[d].targets), a[d - 1].pos + a[d - 1].size > c && (a[d - 1].pos = c - a[d - 1].size), a.splice(d, 1), f = !0)
...
}), C(O)===0 || this.verifyDataLabelOverflow(O)) && (this.placeDataLabels(), G && e && I(this.points, function(a) {
...
a.color||"#666666"});} A[b ? 'attr':'animate']({d: d.connectorPath(a.labelPos)}); A.attr('visibility', P)
...
var c = this.center, b = this.options, f = b.center, h = b.minSize || 80, l, e; f[0]!==null ? l = Math.max(c[2] - Math.max(a[1], a[3]), h):(l = Math.max(c[2] - a[1] - a[3], h), c[0] += (a[3] - a[1]) / 2); f[1]!==null ? l = Math.max(Math.min(l, c[2] - Math.max(a[0], a[2])), h):(l = Math.max(Math.min(l, c[2] - a[0] - a[2]), h), c[1] += (a[0] - a[2]) / 2); l < c[2] ? (c[2] = l, c[3] = Math.min(d(b.innerSize ||
0, l), l), this.translate(c), this.drawDataLabels && this.drawDataLabels()):e = !0; return e
 ...
 var l = this.chart.inverted, e = a.series, m = a.dlBox || a.shapeArgs, n = u(a.below, a.plotY > u(this.translatedThreshold, e.yAxis.len)), p = u(b.inside, !!this.options.stacking); m && (f = v(m), f.y<0 && (f.height += f.y, f.y = 0), m = f.y + f.height - e.yAxis.len, m>0 && (f.height -= m), l && (f = {x: e.yAxis.len - f.y - f.height, y: e.xAxis.len - f.x - f.width, width: f.height, height: f.width}), p || (l ? (f.x += n ?
...
zoomOut: function() { var a = this; l(a, 'selection', {resetSelection: !0}, function() { a.zoom() }) },
zoom: function(a) { var b, d = this.pointer, f = !1, h; !a || a.resetSelection ? p(this.axes, function(a) { b = a.zoom() }):p(a.xAxis.concat(a.yAxis), function(a) { var c = a.axis; d[c.isXAxis ? 'zoomX':'zoomY'] && (b = c.zoom(a.min, a.max), c.displayBtn && (f = !0)) }); h = this.resetZoomButton; f && !h ? this.showResetZoom():!f && c(h) && (this.resetZoomButton = h.destroy()); b && this.redraw(t(this.options.chart.animation, a && a.animation, this.pointCount<100)) },
  pan: function(a, b) {
var c = this, e = c.hoverPoints, d; e && p(e, function(a) { a.setState() }); p('xy' === b ? [1, 0]:[1], function(b) { b = c[b ? 'xAxis':'yAxis'][0]; var e = b.horiz, f = a[e ? 'chartX':'chartY'], e = e ? 'mouseDownX':'mouseDownY', h = c[e], k = (b.pointRange || 0) / 2, g = b.getExtremes(), l = b.toValue(h - f, !0) + k, k = b.toValue(h + b.len - f, !0) - k, m = k < l, h = m ? k:l, l = m ? l:k, k = Math.min(g.dataMin, g.min) - h, g = l - Math.max(g.dataMax, g.max); b.series.length && k<0 && g<0 && (b.setExtremes(h, l, !1, !1, {trigger: 'pan'}), d = !0); c[e] = f }); d && c.redraw(!1); I(c.container,
{cursor: 'move'})
}}); v(m.prototype, {select: function(a, b) { var c = this, e = c.series, f = e.chart; a = t(a, !c.selected); c.firePointEvent(a ? 'select':'unselect', {accumulate: b}, function() { c.selected = c.options.selected = a; e.options.data[d(c, e.data)] = c.options; c.setState(a && 'select'); b || p(f.getSelectedPoints(), function(a) { a.selected && a !== c && (a.selected = a.options.selected = !1, e.options.data[d(a, e.data)] = a.options, a.setState(''), a.firePointEvent('unselect')) }) }) },
...
onMouseOut: function() { var a = this.series.chart, b = a.hoverPoints; this.firePointEvent('mouseOut'); b && d(this,b)!==-1 || (this.setState(), a.hoverPoint = null) },
...
haloPath: function(a) { return this.series.chart.renderer.symbols.circle(Math.floor(this.plotX) - a, this.plotY - a, 2 * a, 2 * a) }}); v(b.prototype, {onMouseOver: function() { var a = this.chart, b = a.hoverSeries; if(b && b !== this)b.onMouseOut(); this.options.events.mouseOver && l(this, 'mouseOver'); this.setState('hover'); a.hoverSeries = this },
onMouseOut: function() {
...
select: function(a) { this.selected = a = void 0 === a ? !this.selected:a; this.checkbox && (this.checkbox.checked = a); l(this, a ? 'select':'unselect') },
...
}; D.prototype.currentOptions = function(a) { function h(a, d, c) { var l, p; for(l in a)if(G(l,["series","xAxis","yAxis"])>-1)for(a[l] = f(a[l]), c[l] = [], p = 0; p < a[l].length; p++)c[l][p] = {}, h(a[l][p], d[l][p], c[l][p]); else I(a[l]) ? (c[l] = {}, h(a[l], d[l] || {}, c[l])):c[l] = d[l] || null }var l = {}; h(a, this.options, l); return l }
})(L); return L
 })
